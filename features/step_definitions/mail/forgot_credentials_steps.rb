Then /^Mail: Open Forgot Username Modal/ do
  ...
  @forgot_username = web_apps.mail.landing_page.forgot_username if @forgot_username.nil?
...
Then /^Mail: Open Forgot Password Modal/ do
  ...
  @forgot_password = web_apps.mail.landing_page.forgot_password if @forgot_password.nil?
end
