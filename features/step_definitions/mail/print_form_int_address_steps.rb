...
Then /^[Ss]et Print form Name to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_name] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form Company to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_company] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form Address 1 to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_street_address_1] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form Address 2 to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_street_address_2] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form City to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_city] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form Province to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_province] = (value.downcase == 'random')? helper.random_name : value
...
Then /^[Ss]et Print form Postal Code to (?:tab|enter|(.*))$/ do |value|
  ...
  parameter[:mail_to_postal_code] = (value.downcase == 'random')? helper.random_name : value
