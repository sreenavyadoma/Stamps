...
Then /^Postage Extra Services: Set Electronic Return Receipt to Unchecked$/ do
  log.info "Step: Postage Extra Services: Electronic Uncheck Return Receipt"
