Then /^Postage: Open Forgot Username Modal/ do
  ...
  @forgot_username = postage.sign_in_page.forgot_username if @forgot_username.nil?
...
Then /^Postage: Open Forgot Password Modal/ do
  ...
  @forgot_password = postage.sign_in_page.forgot_password if @forgot_password.nil?
end
