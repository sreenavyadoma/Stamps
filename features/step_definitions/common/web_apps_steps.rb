...
Given /^(?:|(?:|(?:A|a) )(?:(?:v|V)alid |))(?:U|u)ser is signed in to Web Apps$/ do
  ...
  test_data[:username] = stamps.orders.landing_page.orders_sign_in if param.web_app == :orders
  test_data[:username] = stamps.mail.sign_in_modal.mail_sign_in if param.web_app == :mail
