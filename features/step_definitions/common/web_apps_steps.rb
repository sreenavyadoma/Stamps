...
Given /^(?:|(?:|[Aa] )(?:[Vv]alid |))[Uu]ser is signed in to Web Apps$/ do
  ...
  test_param[:username] = stamps.orders.landing_page.orders_sign_in(:default) if param.web_app == :orders
  test_param[:username] = stamps.mail.sign_in_modal.mail_sign_in(:default) if param.web_app == :mail
