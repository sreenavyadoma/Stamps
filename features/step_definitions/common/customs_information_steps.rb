...
Then /^[Ss]et Customs form Package Contents to (.*)$/ do |value|
  ...
  stamps.orders.order_details.customs.edit_form.package_contents.select(test_param[:customs_package_contents]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.package_contents.select(test_param[:customs_package_contents]) if param.web_app == :mail
...
Then /^[Ss]et Customs form Non-Delivery Options to (.*)$/ do |value|
  ...
  stamps.orders.order_details.customs.edit_form.non_delivery_options.select(test_param[:customs_non_delivery_options]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.non_delivery_options.select(test_param[:customs_non_delivery_options]) if param.web_app == :mail
end
...
Then /^[Ss]et Customs form Internal Transaction Number to (.*)$/ do |value|
  ...
  stamps.orders.order_details.customs.edit_form.internal_transaction.select(test_param[:customs_internal_transaction_no]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.internal_transaction.select(test_param[:customs_internal_transaction_no]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form More Info to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.orders.order_details.customs.edit_form.package_contents.contents.more_info.set(test_param[:customs_more_info]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.package_contents.contents.more_info.set(test_param[:customs_more_info]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form ITN Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.orders.order_details.customs.edit_form.itn_number.set(test_param[:customs_itn_no]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.itn_number.set(test_param[:customs_itn_no]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form License Number to (?:(?:a|some) random string|(.*))$/ do |value|
  test_param[:customs_license_no] = ((value.nil?)?helper.random_alpha_numeric(6): value)
  stamps.orders.order_details.customs.edit_form.package_contents.contents.license.set(test_param[:customs_license_no]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.package_contents.contents.license.set(test_param[:customs_license_no]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form Certificate Number to (?:(?:a|some) random string|(.*))$/ do |value|
  test_param[:customs_certificate_no] = ((value.nil?)?helper.random_alpha_numeric(8):value)
  stamps.orders.order_details.customs.edit_form.package_contents.contents.certificate.set(test_param[:customs_certificate_no]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.package_contents.contents.certificate.set(test_param[:customs_certificate_no]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form Invoice Number to (?:(?:a|some) random string|(.*))$/ do |value|
  test_param[:customs_invoice_no] = (value.nil?)?helper.random_alpha_numeric(10):value
  stamps.orders.order_details.customs.edit_form.package_contents.contents.invoice.set(test_param[:customs_invoice_no]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.package_contents.contents.invoice.set(test_param[:customs_invoice_no]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]ave Customs Information form [Tt]otal amount$/ do
  test_param[:customs_total_value] = stamps.orders.order_details.customs.edit_form.total_value if param.web_app == :orders
  test_param[:customs_total_value] = stamps.mail.print_form.mail_customs.edit_form.total_value if param.web_app == :mail
end
...
Then /^[Ss]et Customs form Associated Item (\d+) Description to (.*)$/ do |item_number, value|
  ...
  stamps.orders.order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_description.set(test_param[:customs_associated_items][item_number][:description]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_description.set(test_param[:customs_associated_items][item_number][:description]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form Associated Item (\d+) Qty to (\d+)$/ do |item_number, value|
  ...
  stamps.orders.order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_qty.set(test_param[:customs_associated_items][item_number][:quantity]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_qty.set(test_param[:customs_associated_items][item_number][:quantity]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form Associated Item (\d+) Unit Price to (.*)$/ do |item_number, value|
  ...
  stamps.orders.order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_unit_price.set(test_param[:customs_associated_items][item_number][:price]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_unit_price.set(test_param[:customs_associated_items][item_number][:price]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs form Associated Item (\d+) Made In is Country to (.*)$/ do |item_number, value|
  ...
  stamps.orders.order_details.customs.edit_form.associated_items.item_number(item_number.to_i).made_in.select(test_param[:customs_associated_items][item_number][:made_in]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.associated_items.item_number(item_number.to_i).made_in.select(test_param[:customs_associated_items][item_number][:made_in]) if param.web_app == :mail
end
...
Then /^[Ss]et Customs form Associated Item (\d+) Tarriff to (.*)$/ do |item_number, value|
  ...
  stamps.orders.order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_hs_tariff.set(test_param[:customs_associated_items][item_number][:tarriff]) if param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_hs_tariff.set(test_param[:customs_associated_items][item_number][:tarriff]) if param.web_app == :mail
  step "Save Customs Information form Total amount"
end
