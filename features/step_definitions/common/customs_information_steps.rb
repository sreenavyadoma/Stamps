...
Then /^[Ss]et Customs Package Contents to (.*)$/ do |value|
  ...
  stamps.common_modals.customs_form.package_contents.select(TestData.store[:customs_package_contents]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.package_contents.select(TestData.store[:customs_package_contents]) if modal_param.web_app == :mail
...
Then /^[Ss]et Customs Non-Delivery Options to (.*)$/ do |value|
  ...
  stamps.common_modals.customs_form.non_delivery_options.select(TestData.store[:customs_non_delivery_options]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.non_delivery_options.select(TestData.store[:customs_non_delivery_options]) if modal_param.web_app == :mail
end
...
Then /^[Ss]et Customs Internal Transaction Number to (.*)$/ do |value|
  ...
  stamps.common_modals.customs_form.internal_transaction.select(TestData.store[:customs_internal_transaction_no]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.internal_transaction.select(TestData.store[:customs_internal_transaction_no]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs More Info to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.common_modals.customs_form.package_contents.contents.more_info.set(TestData.store[:customs_more_info]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.package_contents.contents.more_info.set(TestData.store[:customs_more_info]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs ITN Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.common_modals.customs_form.itn_number.set(TestData.store[:customs_itn_no]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.itn_number.set(TestData.store[:customs_itn_no]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs License Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.common_modals.customs_form.license.set(TestData.store[:customs_license_no]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.license.set(TestData.store[:customs_license_no]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs Certificate Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.common_modals.customs_form.certificate.set(TestData.store[:customs_certificate_no]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.certificate.set(TestData.store[:customs_certificate_no]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs Invoice Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.common_modals.customs_form.invoice.set(TestData.store[:customs_invoice_no]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.invoice.set(TestData.store[:customs_invoice_no]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]ave Customs Information form [Tt]otal amount$/ do
  TestData.store[:customs_total_value] = stamps.common_modals.customs_form.total_cost.text.dollar_amount_str.to_f.round(2) if modal_param.web_app == :orders
  TestData.store[:customs_total_value] = stamps.mail.print_form.mail_customs.edit_customs_form.total_cost.text.dollar_amount_str.to_f.round(2) if modal_param.web_app == :mail
end
...
Then /^[Ss]et Customs Associated Item (\d+) Description to (.*)$/ do |item_number, value|
  ...
  stamps.common_modals.customs_form.associated_items.item_number(item_number.to_i).item_description.set(TestData.store[:customs_associated_items][item_number][:description]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.associated_items.item_number(item_number.to_i).item_description.set(TestData.store[:customs_associated_items][item_number][:description]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs Associated Item (\d+) Qty to (\d+)$/ do |item_number, value|
  ...
  stamps.common_modals.customs_form.associated_items.item_number(item_number.to_i).item_qty.set(TestData.store[:customs_associated_items][item_number][:quantity]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.associated_items.item_number(item_number.to_i).item_qty.set(TestData.store[:customs_associated_items][item_number][:quantity]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs Associated Item (\d+) Unit Price to (.*)$/ do |item_number, value|
  ...
  stamps.common_modals.customs_form.associated_items.item_number(item_number.to_i).unit_price.set(TestData.store[:customs_associated_items][item_number][:price]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.associated_items.item_number(item_number.to_i).unit_price.set(TestData.store[:customs_associated_items][item_number][:price]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
...
Then /^[Ss]et Customs Associated Item (\d+) Tarriff to (.*)$/ do |item_number, value|
  ...
  stamps.common_modals.customs_form.associated_items.item_number(item_number.to_i).hs_tariff.set(TestData.store[:customs_associated_items][item_number][:tarriff]) if modal_param.web_app == :orders
  stamps.mail.print_form.mail_customs.edit_customs_form.associated_items.item_number(item_number.to_i).hs_tariff.set(TestData.store[:customs_associated_items][item_number][:tarriff]) if modal_param.web_app == :mail
  step "Save Customs Information form Total amount"
end
