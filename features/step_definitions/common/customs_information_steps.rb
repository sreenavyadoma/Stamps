...
Then /^[Ss]et Customs form Package Contents to (.*)$/ do |value|
  ...
  stamps.orders.single_order_details.customs.edit_form.package_contents.select(test_param[:customs_package_contents]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Package Contents is (?:correct|(.*))$/ do |expectation|
  ...
  sleep(0.15)
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.combobox.textbox.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Non-Delivery Options to (.*)$/ do |value|
  ...
  stamps.orders.single_order_details.customs.edit_form.non_delivery_options.select(test_param[:customs_non_delivery_options]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Non-Delivery Options is (?:correct|(.*))$/ do |expectation|
  ...
  10.times do
    if modal_param.web_app == :orders
      actual = stamps.orders.single_order_details.customs.edit_form.non_delivery_options.textbox.text
  ...
  expect(stamps.orders.single_order_details.customs.edit_form.non_delivery_options.textbox.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Internal Transaction Number to (.*)$/ do |value|
  ...
  stamps.orders.single_order_details.customs.edit_form.internal_transaction.select(test_param[:customs_internal_transaction_no]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Internal Transaction Number is (?:correct|(.*))$/ do |expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.internal_transaction.textbox.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form More Info to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.orders.single_order_details.customs.edit_form.package_contents.contents.more_info.set(test_param[:customs_more_info]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form More Info is (?:correct|(.*))$/ do |expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.contents.more_info.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form ITN Number to (?:(?:a|some) random string|(.*))$/ do |value|
  ...
  stamps.orders.single_order_details.customs.edit_form.itn_number.set(test_param[:customs_itn_no]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form ITN Number is (?:correct|(.*))$/ do |expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.itn_number.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Dd]elete Customs form Associated Item (\d+)$/ do |item_number|
  element = stamps.orders.single_order_details.customs.edit_form.associated_items if modal_param.web_app == :orders
...
Then /^[Cc]heck Customs form I agree to the USPS Privacy Act Statement$/ do
  stamps.orders.single_order_details.customs.edit_form.agree_to_terms.check if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form I agree to the USPS Privacy Act Statement is checked$/ do
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.agree_to_terms.checked?).to be(true) if modal_param.web_app == :orders
...
Then /^[Uu]ncheck Customs form I agree to the USPS Privacy Act Statement$/ do
  stamps.orders.single_order_details.customs.edit_form.agree_to_terms.uncheck if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form USPS Privacy Act Warning is visible$/ do
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.usps_privacy_act_warning.visible?).to be(true) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form USPS Privacy Act Warning is hidden$/ do
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.usps_privacy_act_warning.visible?).to be(false) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form License Number is hidden$/ do
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.contents.license.present?).not_to be(true) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Certificate Number is hidden$/ do
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.contents.certificate.present?).not_to be(true) if modal_param.web_app == :orders
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.contents.certificate.present?).not_to be(true) if modal_param.web_app == :mail
end
...
Then /^[Ee]xpect Customs form Invoice Number is hidden$/ do
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.package_contents.contents.invoice.present?).not_to be(true) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form ITN Number is hidden$/ do
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.itn_number.enabled?).to be(true) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item Grid count is (.+)$/ do |expectation|
  step "Blur out on Customs form"
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.associated_items.size).to eql(expectation.to_i) if modal_param.web_app == :orders
...
Then /^[Ss]ave Customs Information form [Tt]otal amount$/ do
  test_param[:customs_total_value] = stamps.orders.single_order_details.customs.edit_form.total_value if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Total Value is (?:correct|(.*))$/ do |expectation|
  ...
  step "Blur out on Customs form"
  expect(stamps.orders.single_order_details.customs.edit_form.total_value).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Aa]dd Customs form Associated Item (\d+)$/ do |item_number|
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Associated Item (\d+) Description to (.*)$/ do |item_number, value|
  ...
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_description.set(test_param[:customs_associated_items][item_number][:description]) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Associated Item (\d+) Qty to (\d+)$/ do |item_number, value|
  ...
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_qty.set(test_param[:customs_associated_items][item_number][:quantity]) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Associated Item (\d+) Unit Price to (.*)$/ do |item_number, value|
  ...
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_unit_price.set(test_param[:customs_associated_items][item_number][:price]) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Associated Item (\d+) Made In is Country to (.*)$/ do |item_number, value|
  ...
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).made_in.select(test_param[:customs_associated_items][item_number][:made_in]) if modal_param.web_app == :orders
...
Then /^[Ss]et Customs form Associated Item (\d+) Tarriff to (.*)$/ do |item_number, value|
  ...
  stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_hs_tariff.set(test_param[:customs_associated_items][item_number][:tarriff]) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item (\d+) Description is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_description.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item (\d+) Quantity is (?:correct|(\d+))$/ do |item_number, expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_qty.textbox.text.to_i).to eql(expectation.to_i) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item (\d+) Unit Price is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_unit_price.textbox.text.to_f).to eql(expectation.to_f) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item (\d+) Made In is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  sleep(0.5)
  expect(stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).made_in.textbox.text).to eql(expectation) if modal_param.web_app == :orders
...
Then /^[Ee]xpect Customs form Associated Item (\d+) Tariff is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  sleep(0.5)
  expect((stamps.orders.single_order_details.customs.edit_form.associated_items.item_number(item_number.to_i).customs_item_hs_tariff.text).to_f).to eql(expectation.to_f) if modal_param.web_app == :orders
