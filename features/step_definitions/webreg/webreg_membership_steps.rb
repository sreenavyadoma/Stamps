...
Then /^WebReg Membership: Set Last Name to (.*)$/ do |var|
  logger.info "WebReg Membership: Set Last Name to #{var}"
...
Then /^WebReg Membership: Set Company to (.*)$/ do |var|
  logger.info "WebReg Membership: Set Company to #{var}"
...
Then /^WebReg Membership: Set Extenion to (.*)$/ do |var|
  logger.info "WebReg Membership: Set Extenion to #{var}"
...
Then /^WebReg Membership: Set Cardholder name to (.*)$/ do |var|
  logger.info "WebReg Membership: Set Cardholder name to #{var}"
...
Then /^WebReg Membership: Set Billing address same as mailing address to Checked$/ do
  logger.info "WebReg Membership: Set Billing address same as mailing address to Checked"
