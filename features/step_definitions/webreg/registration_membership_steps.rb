...
Then /^Registration Membership: Set Extenion to (.*)$/ do |var|
  ...
  registration.profile.membership.ext.set (var.downcase.include? "random") ? ParameterHelper.random_phone_extension : var
end

Then /^Registration Membership: Set Cardholder name to (.*)$/ do |var|
  logger.info "Registration Membership: Set Cardholder name to #{var}"
  registration.profile.membership.card_holder_name.set (var.downcase.include? "random") ? ParameterHelper.random_name : var
end

Then /^Registration Membership: Set Card number to (.*)$/ do |var|
  logger.info "Registration Membership: Set Card number to #{var}"
  registration.profile.membership.card_number.set var
end
...
Then /^Registration Membership: Set Expiration Year to (\d+)$/ do |var|
  ...
  registration.profile.membership.expiration_year.select var
end
...
Then /^Registration Membership: Submit$/ do
  ...
  @registration_result = registration.profile.membership.submit
end
