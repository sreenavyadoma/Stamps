...
#* Expect value is added to customer balance
 ...
 Then /^Buy \$(\d+) postage$/ do |amount|
   ...
   batch.navigation_bar.confirm_postage.verify_confirm_modal
   log "Waiting for purchase processing to complete"
   batch.navigation_bar.purchase_processing.wait_for_purchase_confirmation
   log "Purchase Complete, clicking OK"
   batch.navigation_bar.purchase_complete.complete_purchase
 end
