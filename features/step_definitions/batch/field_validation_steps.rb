...
Given /^Expect Order Form International Name data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International Name data error tooltip to be #{value}"
...
Given /^Expect Order Form International Company data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International Company data error tooltip to be #{value}"
...
Given /^Expect Order Form International Address 1 data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International Address 1 data error tooltip to be #{value}"
...
Given /^Expect Order Form International City data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International City data error tooltip to be #{value}"
...
Given /^Expect Order Form International Phone data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International Phone data error tooltip to be #{value}"
...
Given /^Expect Order Form International Email data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form International Email data error tooltip to be #{value}"
...
Given /^Expect Order Form Domestic Email data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form Domestic Email data error tooltip to be #{value}"
...
Given /^Expect Order Form Length data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form Length data error tooltip to be #{value}"
...
Given /^Expect Order Form Width data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form Width data error tooltip to be #{value}"
...
Given /^Expect Order Form Height data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Order Form Height data error tooltip to be #{value}"
...
Given /^Expect Grid ship cost data error tooltip to be \"(.+)\"$/ do |value|
  log "Step: Expect Grid ship cost data error tooltip to be #{value}"
...
Then /^Expect Grid Ship Cost error to contain \"(.*)\"$/ do |expectation|
  log "Step: Expect Grid Ship Cost error to contain #{expectation}"
  # 81453
  # 81408
  # 81407
