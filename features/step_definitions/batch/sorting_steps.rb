...
Then /^Sort Grid by State in Descending order$/ do
  ...
  log.info "Step #{(sorted)?'Passed':'Failed'} - Sort Grid by State in Descending order"
  sorted.should be true
end
