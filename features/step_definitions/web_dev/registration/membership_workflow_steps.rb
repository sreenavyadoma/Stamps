...
Then /^[Ss]et [Mm]embership [Pp]age [Ff]irst [Nn]ame to (?:random value|(.*))$/ do |str|
  ...
  registration.membership.first_name.set(test_param[:first_name] = str.nil? ? TestHelper.rand_alpha_str.capitalize  : str)
end
...
Then /^[Ss]et [Mm]embership [Pp]age [Ll]ast [Nn]ame to (?:random value|(.*))$/ do |str|
  registration.membership.last_name.set(test_param[:last_name] = str.nil? ? TestHelper.rand_alpha_str.capitalize  : str)
end
...
Then /^[Ss]et [Mm]embership [Pp]age [Cc]ompany to (?:random value|(.*))$/ do |str|
  registration.membership.company.set(test_param[:company] = str.nil? ? TestHelper.rand_alpha_str  : str) if registration.membership.company.present?
end
...
Then /^[Ss]et [Mm]embership [Pp]age [Pp]hone to (?:random value|(.*))$/ do |str|
  registration.membership.phone.set(test_param[:phone] = str.nil? ? TestHelper.rand_phone_format : str)
end

Then /^[Ee]xpect [Mm]embership [Pp]age [Pp]hone is (?:correct|(.*))$/ do |str|
  expect(registration.membership.phone.text).to eql(str.nil? ? test_param[:phone] : str)
end

Then /^[Ss]et [Mm]embership [Pp]age [Cc]ardholder's [Nn]ame to (?:random value|(.*))$/ do |str|
  test_param[:card_holder_name] = str.nil? ? TestHelper.rand_full_name  : str
...
Then /^[Ss]et [Mm]embership [Pp]age [Bb]illing [Aa]ddress to (.*)$/ do |str|
  registration.membership.billing_address.set(test_param[:billing_address] = str.nil? ? TestHelper.rand_alpha_str.capitalize  : str)
  step "blur_out on membership page"
...
Then /^[Ss]et [Mm]embership [Pp]age [Bb]illing [Cc]ity to (.*)$/ do |str|
  registration.membership.billing_city.set(test_param[:billing_city] = str.nil? ? TestHelper.rand_alpha_str.capitalize  : str)
  step "blur_out on membership page"
end
...
Then /^[Ss]et [Mm]embership [Pp]age [Bb]illing [Zz]ip to (.*)$/ do |str|
  registration.membership.billing_zip.set(test_param[:billing_zip] = str.nil? ? TestHelper.rand_alpha_str.capitalize  : str)
end
