...
Then /^Details: Expect Service to be First-Class Mail Large Envelope\/Flat$/ do
  step "Details: Expect Service to be \"First-Class Mail Large Envelope\""
end
...
Then /^Details: Expect Service to be First-Class Mail Package\/Thick Envelope$/ do
  step "Details: Expect Service to be \"First-Class Mail Package\""
end
...
Then /^Details: Expect Service to be Priority Mail Large\/Thick Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Large\""
end
...
Then /^Details: Expect Service to be Priority Mail Package$/ do
  step "Details: Expect Service to be \"Priority Mail Package\""
end
...
Then /^Details: Expect Service to be Priority Mail Large Package$/ do
  step "Details: Expect Service to be \"Priority Mail Large Package\""
end
...
Then /^Details: Expect Service to be Priority Mail Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Padded Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Padded Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Legal Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Legal Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Small Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail Small Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail Medium Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail Medium Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail Large Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail Large Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail Regional Rate Box A$/ do
  step "Details: Expect Service to be \"Priority Mail Regional Rate Box A\""
end
...
Then /^Details: Expect Service to be Priority Mail Regional Rate Box B$/ do
...
Then /^Details: Expect Service to be Priority Mail Express Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Express Padded Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express Padded Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Express Legal Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express Legal Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Media Mail Package\/Flat\/Thick Envelope$/ do
  step "Details: Expect Service to be \"Media Mail Package\""
end
...
Then /^Details: Expect Service to be Parcel Select Ground Package\/Flat\/Thick Envelope$/ do
  step "Details: Expect Service to be \"Parcel Select Ground Package\""
end
...
Then /^Details: Expect Service to be Parcel Select Ground Oversized Package$/ do
  step "Details: Expect Service to be \"Parcel Select Ground Oversized Package\""
end
...
Then /^Details: Expect Service to be First-Class Mail International Large Envelope\/Flat$/ do
  step "Details: Expect Service to be \"First-Class Mail International Large Envelope\""
end
...
Then /^Details: Expect Service to be First-Class Mail International Package\/Thick Envelope$/ do
  step "Details: Expect Service to be \"First-Class Mail International Package\""
end

#Priority Mail International

Then /^Details: Select Service Priority Mail International Package\/Flat\/Thick Envelope$/ do
  step "Details: Set Service to Priority Mail International Package"
end

Then /^Details: Expect Service to be Priority Mail International Package\/Flat\/Thick Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail International Package\""
end
...
Then /^Details: Expect Service to be Priority Mail International Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail International Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail International Padded Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail International Padded Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail International Legal Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail International Legal Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail International Small Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail International Small Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail International Medium Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail International Medium Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail International Large Flat Rate Box$/ do
  step "Details: Expect Service to be \"Priority Mail International Large Flat Rate Box\""
end
...
Then /^Details: Expect Service to be Priority Mail International Regional Rate Box A$/ do
  step "Details: Expect Service to be \"Priority Mail International Regional Rate Box A\""
end
...
Then /^Details: Expect Service to be Priority Mail International Regional Rate Box B$/ do
  step "Details: Expect Service to be \"Priority Mail International Regional Rate Box B\""
end
...
Then /^Details: Expect Service to be Priority Mail Express International Package\/Flat\/Thick Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express International Package\""
end
...
Then /^Details: Expect Service to be Priority Mail Express International Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express International Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Express International Padded Flat Rate Envelope$/ do
  step "Details: Expect Service to be \"Priority Mail Express International Padded Flat Rate Envelope\""
end
...
Then /^Details: Expect Service to be Priority Mail Express International Legal Flat Rate Envelope$/ do
...
Then /^Details: Set Service to (.*)$/ do |service|
  ...
  #@details_form_dataa[:insure_for_cost] = service_cost
end
