...
Then /^(?:E|e)xpect Orders Grid Order ID is the same as Details Form Order ID$/ do
...
Then /^(?:E|e)xpect Orders Grid saved Order ID is in Orders Grid row (\d+)$/ do |row|
...
Then /^(?:E|e)xpect Orders Grid Ship Cost is the same as Details Form Ship Cost$/ do
...
Then /^(?:E|e)xpect Orders Grid Age is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Order Date is populated$/ do
  expect(test_parameter[:order_id]).to be_truthy
...
Then /^(?:E|e)xpect Orders Grid Recipient is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Company is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Address is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid City is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid State is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Zip is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Country is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Email is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Phone is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Ounces is (?:correct|(.*))$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Weight is (\d+) lb. (\d+) oz.$/ do |pounds, ounces|
...
Then /^(?:E|e)xpect Orders Grid Weight\(lb\) is (.*)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Weight\(oz\) is (.*)$/ do |expectation|
  10.times { break if stamps.orders.orders_grid.column.weight.oz(test_parameter[:order_id]).eql? expectation }
  expect(stamps.orders.orders_grid.column.weight.oz(test_parameter[:order_id])).to eql expectation
end

Then /^(?:E|e)xpect Orders Grid Qty. is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Item SKU is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Item Name is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Ship From is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid service is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Insured Value is \$(.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Reference No. is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Cost Code is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Tracking service is USPS Tracking$/ do
  step "expect Orders Grid Tracking service is \"USPS Tracking\""
end

Then /^(?:E|e)xpect Orders Grid Tracking service is Signature Required$/ do
  step "expect Orders Grid Tracking service is \"Signature Required\""
end

Then /^(?:E|e)xpect Orders Grid Tracking service is None$/ do
  step "expect Orders Grid Tracking service is \"None\""
end

Then /^(?:E|e)xpect Orders Grid Tracking service is \"(.+)\"$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Order Status is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Tracking Number is populated$/ do
...
Then /^(?:E|e)xpect Orders Grid Order Total is (.+)$/ do |expectation|
...
Then /^(?:E|e)xpect Orders Grid Ship Cost error to contain \"(.*)\"$/ do |expectation|
  grid_order_id = stamps.orders.orders_grid.column.order_id.row 1
...
Then /^(?:E|e)xpect Orders Grid ship cost data error tooltip is \"(.*)\"$/ do |expectation|
