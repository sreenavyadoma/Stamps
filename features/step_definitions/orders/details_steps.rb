...
And /^Details: Expect Ship-From Textbox to be enabled$/ do
  ...
  enabled = orders.details.ship_from.text_box.element.visible?
  expectation = "enabled"
...
And /^Details: Expect Ship-From drop-down be enabled$/ do
  ...
  enabled = orders.details.ship_from.drop_down.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Ship-To Textbox to be enabled$/ do
  ...
  enabled = orders.details.ship_to.address.text_area.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Ship-To drop-down to be enabled$/ do
  ...
  enabled = orders.details.ship_to.country.drop_down.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Phone Textbox to be enabled$/ do
  ...
  enabled = orders.details.ship_to.address.phone.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Email Textbox to be enabled$/ do
  ...
  enabled = orders.details.ship_to.address.email.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Pounds Textbox to be enabled$/ do
  ...
  enabled = orders.details.weight.lbs.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Ounces Textbox to be enabled$/ do
  ...
  enabled = orders.details.weight.oz.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Service Textbox to be enabled$/ do
  ...
  enabled = orders.details.service.text_box.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Service drop-down to be enabled$/ do
  ...
  enabled = orders.details.service.drop_down.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Insure-For Textbox to be enabled$/ do
  ...
  enabled = orders.details.insure_for.text_box.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Expect Order Detials Form Tracking Textbox to be enabled$/ do
  ...
  enabled = orders.details.tracking.text_box.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
...
And /^Details: Expect Tracking drop-down to be enabled$/ do
  ...
  enabled = orders.details.tracking.drop_down.element.visible?
  expectation = "enabled"
  expectation = "disabled" unless enabled
  logger.info "Test #{(expectation=="enabled")?"Passed":"Failed"}"
  expectation.should eql "enabled"
