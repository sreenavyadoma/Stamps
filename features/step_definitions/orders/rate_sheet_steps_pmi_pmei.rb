    ...
    begin
      if row_number > 0
        ...
        if row[group_column] == nil
          ...
          SdcLogger.debug "#{"#" * 10} Price: #{TestData.store[:result_sheet][row_number, TestData.store[:result_sheet_columns][:group]]}"
          SdcLogger.debug "#{"#" * 10} "
          SdcLogger.debug "#{"#" * 50}"
          ...
          SdcLogger.debug "#{"#" * 10} Desired Service: #{service}"
          ...
          SdcLogger.debug "#{"#" * 10} "
          SdcLogger.debug "#{"#" * 10} Selected Weight: #{TestData.store[:result_sheet][row_number, TestData.store[:result_sheet_columns][:weight]]}"
          ...
          SdcLogger.debug "#{"#" * 10} Selected Country: #{TestData.store[:country]}"
          SdcLogger.debug "#{"#" * 10} #{"*" * 5} Test #{TestData.store[:result_sheet][row_number, TestData.store[:result_sheet_columns][:status]] } - Expected #{TestData.store[:result_sheet][row_number, TestData.store[:result_sheet_columns][:group]]}, Got #{TestData.store[:result_sheet][row_number, TestData.store[:result_sheet_columns][:total_ship_cost]]} #{"*" * 5}"
          SdcLogger.debug "#{"#" * 10} "
        end
