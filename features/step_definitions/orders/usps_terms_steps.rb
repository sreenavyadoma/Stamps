Then /^[Ee]xpect USPS Terms modal appears$/ do
  #config.logger.step "Expect USPS Terms modal appears"
...
Then /^Check Do Not Show Again checkbox in USPS Terms modal$/ do
  #config.logger.step "Check Do Not Show Again checkbox in USPS Terms modal"
  sleep(2)
