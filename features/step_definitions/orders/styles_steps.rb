Then /^[Ee]xpect Style for General Fonts font-family to include (.*)$/ do |font|
  #SdcLog.step "Expect Style for General Fonts font-family to include #{font}"
...
Then /^[Ee]xpect Style for General Fonts Size is (.*)$/ do |size|
  #SdcLog.step "Expect Style for General Fonts Size is #{size}"
...
Then /^[Ee]xpect Style for General Fonts Color is (.*)$/ do |color|
  #SdcLog.step "Expect Style for General Fonts Color is #{color}"
...
Then /^[Ee]xpect Style for General Tooltip Border width is (.*)$/ do |width|
  #SdcLog.step "Expect Style for General Tooltip Border width is #{width}"
...
Then /^[Ee]xpect Style for General Tooltip Border radius is (.*)$/ do |border_style|
  #SdcLog.step "Expect Style for General Tooltip Border radius is #{border_style}"
...
Then /^[Ee]xpect Style for Navigation Header Height is (.*)$/ do |height|
  #SdcLog.step "Expect Style for Navigation Header Height is #{height}"
...
Then /^[Ee]xpect Style for Navigation Background Color is rgba (.*)$/ do |color|
  #SdcLog.step "Expect Style for Navigation Background Color is #{color}"
...
Then /^[Ee]xpect Style for Navigation Links Color is (.*)$/ do |color|
  #SdcLog.step "Expect Style for Navigation Links Color is #{color}"
