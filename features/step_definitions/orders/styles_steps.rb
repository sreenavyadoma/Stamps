Then /^Expect Style for General Fonts font-family to include (.*)$/ do |font|
  log.info "Step: Expect Style for General Fonts font-family to include #{font}"
...
Then /^Expect Style for General Fonts Size to be (.*)$/ do |size|
  log.info "Step: Expect Style for General Fonts Size to be #{size}"
...
Then /^Expect Style for General Fonts Color to be (.*)$/ do |color|
  log.info "Step: Expect Style for General Fonts Color to be #{color}"
...
Then /^Expect Style for General Tooltip Border width to be (.*)$/ do |width|
  log.info "Step: Expect Style for General Tooltip Border width to be #{width}"
...
Then /^Expect Style for General Tooltip Border radius to be (.*)$/ do |border_style|
  log.info "Step: Expect Style for General Tooltip Border radius to be #{border_style}"
...
Then /^Expect Style for Navigation Header Height to be (.*)$/ do |height|
  log.info "Step: Expect Style for Navigation Header Height to be #{height}"
...
Then /^Expect Style for Navigation Background Color to be rgba (.*)$/ do |color|
  log.info "Step: Expect Style for Navigation Background Color to be #{color}"
...
Then /^Expect Style for Navigation Links Color to be (.*)$/ do |color|
  log.info "Step: Expect Style for Navigation Links Color to be #{color}"
