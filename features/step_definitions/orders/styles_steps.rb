Then /^(?:E|e)xpect Style for General Fonts font-family to include (.*)$/ do |font|
...
Then /^(?:E|e)xpect Style for General Fonts Size is (.*)$/ do |size|
...
Then /^(?:E|e)xpect Style for General Fonts Color is (.*)$/ do |color|
...
Then /^(?:E|e)xpect Style for General Tooltip Border width is (.*)$/ do |width|
...
Then /^(?:E|e)xpect Style for General Tooltip Border style is (.*)$/ do |border_style|
  #logger.step "Expect Style for General Tooltip Border width is #{width}"
  expect(stamps.orders.styles.general.tooltip.border_style.downcase).to eql border_style
end

Then /^(?:E|e)xpect Style for General Tooltip Border radius is (.*)$/ do |border_style|
...
Then /^(?:E|e)xpect Style for Navigation Header Height is (.*)$/ do |height|
...
Then /^(?:E|e)xpect Style for Navigation Background Color is rgba (.*)$/ do |color|
...
Then /^(?:E|e)xpect Style for Navigation Links Color is (.*)$/ do |color|
