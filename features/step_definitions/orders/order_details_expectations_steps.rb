...
Then /^[Ee]xpect [Oo]rder [Dd]etails Ship-From and Ship-From saved values are the same$/ do
  ...
  expect(stamps.orders.order_details.single_ship_from.textbox.text).to eql(test_param[:ship_from])
end
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Insure-For is (?:correct|(\d+.\d*))$/ do |expectation|
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Insure-For Cost is (?:correct|(\d+.\d*))$/ do |expectation|
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Service Cost inline price for "([a-zA-Z -\/]+)" is greater than \$([0-9.]*)$/ do |service, expectation|
  stamps.orders.order_details.wait_until_present(2)
  step "expect Order Details is present"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Service Cost saved value is the same$/ do
  step "expect Order Details Service Cost is #{test_param[:service_cost]}"
end

Then /^[Ee]xpect [Oo]rder [Dd]etails Service Cost is (?:correct|(\d+.\d*))$/ do |expectation|
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Service Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  step "expect Order Details is present"
  expect(stamps.orders.order_details.service.cost).to be > expectation.to_f.round(2)
end

Then /^[Ee]xpect [Oo]rder [Dd]etails Tracking Cost is (?:correct|(\d+.\d*))$/ do |expectation|
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Tracking Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  step "expect Order Details is present"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Total Ship Cost is (?:correct|(\d+.\d*))$/ do |expectation|
...
And /^[Ee]xpect [Oo]rder [Dd]etails Insure-For Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  expect(stamps.orders.order_details.insure_for.textbox.field.visible?).to be(true)
end

And /^[Ee]xpect [Oo]rder [Dd]etails Insure-For Textbox is disabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  expect(stamps.orders.order_details.insure_for.textbox.field.visible?).to be(true)
end
