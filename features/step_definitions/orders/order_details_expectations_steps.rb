...
Then /^[Ee]xpect Order Details form Ship-From and Ship-From saved values are the same$/ do
  ...
  10.times break if stamps.orders.order_details.ship_from.text_box.text == test_parameter[:ship_from]
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) Qty is (?:correct|(\d+))$/ do |item_number, expectation|
  ...
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).item_qty.text_box.text == expectation
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) ID is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).item_id.text == expectation
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) Description is (?:correct|(.*))$/ do |item_number, expectation|
  ...
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).item_description.text == expectation
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) Qty Placeholder is (.*)$/ do |item_number, expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).qty.text_box.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) ID Placeholder is (.*)$/ do |item_number, expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).id.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Associated Item (\d+) Description Placeholder is (.*)$/ do |item_number, expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.items_ordered.item(item_number.to_i).description.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Ship-To Address Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.domestic.text_area.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Ship-To Phone Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.domestic.phone.placeholder == expectation
  stamps.orders.order_details.ship_to.domestic.show_address
...
Then /^[Ee]xpect Order Details form Ship-To Email Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.domestic.email.placeholder == expectation
...
Then /^[Ee]xpect Order Details form service Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.text_box.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Ship-To Country is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.country.text_box.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Name is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.name.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Company is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.company.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Address 1 is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.address_1.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Address 2 is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.address_2.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To City is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.city.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Province is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.province.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Postal Code is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.postal_code.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Phone is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.phone.text == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Email is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.email.text == expectation
...
Then /^[Ee]xpect Order Details form Domestic Ship-To fields are hidden$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times break unless stamps.orders.order_details.ship_to.domestic.text_area.present?
...
Then /^[Ee]xpect Order Details form Customs Restrictions button is visible/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.customs.browser_restrictions_button.present?
...
Then /^[Ee]xpect Order Details form Customs Restrictions button is hidden/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break unless stamps.orders.order_details.customs.browser_restrictions_button.present?
...
Then /^[Ee]xpect Order Details form Customs Edit Form button is visible/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break unless stamps.orders.order_details.customs.edit_form_btn.present?
...
Then /^[Ee]xpect Order Details form Customs Edit Form button is enabled/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.customs.edit_form_btn.present?
  expect(stamps.orders.order_details.customs.edit_form_btn).to be_present
end
...
Then /^[Ee]xpect Order Details form International Ship-To Name Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.name.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Company Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.company.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Address 1 Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.address_1.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Address 2 Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.address_2.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To City Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.city.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Province Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.province.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Postal Code Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.postal_code.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Phone Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.phone.placeholder == expectation
...
Then /^[Ee]xpect Order Details form International Ship-To Email Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.international.email.placeholder == expectation
...
Then /^[Ee]xpect Order Details form Panel is present$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.present?
  expect(stamps.orders.order_details).to be_present
end

Then /^[Ee]xpect Exact Address Not Found module to appear/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.domestic.ambiguous.address_not_found.window_title.text == "Exact Address Not Found"
...
Then /^[Ee]xpect Order Details form Reference Number is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.reference_no.text == expectation
...
Then /^[Ee]xpect Order Details form Insure-For is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.insure_for.text_box.text.to_f.round(2) == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Insure-For Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  5.times break if stamps.orders.order_details.insure_for.cost == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Insure-For Cost is greater than \$(.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.insure_for.cost.to_f > expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form service \"(.*)\" is disabled/ do |service|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.disabled?(service)
...
Then /^[Ee]xpect Order Details form service \"(.*)\" is enabled/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.enabled?(expectation)
...
Then /^[Ee]xpect Pounds tooltip to display - The maximum value for this field is ([0-9.]+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.pounds_max_value == expectation
...
Then /^[Ee]xpect Ounces tooltip to display - The maximum value for this field is ([0-9.]+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ounces_max_value == expectation
...
Then /^[Ee]xpect Order Details form Service Cost inline price for "([a-zA-Z -\/]+)" is greater than \$([0-9.]*)$/ do |service, expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.inline_cost(service).to_f >= expectation.to_f
...
Then /^[Ee]xpect Order Details form Service Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.cost.to_f == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Service Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.cost > expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Tracking Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.tracking.cost == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Tracking Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.tracking.cost.to_f > expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Dimensions are hidden$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break unless stamps.orders.order_details.dimensions.present?
...
Then /^[Ee]xpect Order Details form Length is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.dimensions.length.text_box.text.to_f == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Width is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.dimensions.width.text_box.text.to_f == expectation.to_f.round(2)
...
Then /^[Ee]xpect Order Details form Height is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.dimensions.height.text_box.text.to_i == expectation.to_i
...
Then /^[Ee]xpect Order Details form Tracking is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.tracking.text_box.text.include? expectation
...
Then /^[Ee]xpect Order Details form Total Ship Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.footer.total_ship_cost.eql?(expectation.to_f.round(2))
...
And /^[Ee]xpect Order Details form Ship-To Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times break if stamps.orders.order_details.ship_to.domestic.text_area.element.visible?
...
And /^[Ee]xpect Order Details form Ship-To drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.country.drop_down.element.visible?
...
And /^[Ee]xpect Order Details form Phone Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times break if stamps.orders.order_details.ship_to.domestic.phone.element.visible?
...
And /^[Ee]xpect Order Details form Email Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.ship_to.domestic.email.element.visible?
...
And /^[Ee]xpect Order Details form Pounds Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.weight.lb.element.visible?
...
And /^[Ee]xpect Order Details form Ounces Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.weight.oz.element.visible?
...
And /^[Ee]xpect Order Details form service Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.text_box.element.visible?
...
And /^[Ee]xpect Order Details form service drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.service.drop_down.element.visible?
...
And /^[Ee]xpect Order Details form Insure-For Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.insure_for.text_box.element.visible?
...
And /^[Ee]xpect Order Detials Form Tracking Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.tracking.text_box.element.visible?
...
And /^[Ee]xpect Order Details form Tracking drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times break if stamps.orders.order_details.tracking.drop_down.element.visible?
