...
Then /^[Ee]xpect Order Details form Ship-From and Ship-From saved values are the same$/ do
  ...
  10.times do break if stamps.orders.order_details.ship_from.text_box.text == test_parameter[:ship_from] end
...
Then /^[Ee]xpect Order Details form Ship-To Address Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.domestic.text_area.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form Ship-To Phone Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.domestic.phone.placeholder == expectation end
  stamps.orders.order_details.ship_to.domestic.show_address
...
Then /^[Ee]xpect Order Details form Ship-To Email Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.domestic.email.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form service Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.text_box.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form Ship-To Country is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.country.text_box.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Name is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.name.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Company is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.company.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Address 1 is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.address_1.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Address 2 is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.address_2.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To City is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.city.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Province is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.province.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Postal Code is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.postal_code.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Phone is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.phone.text == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Email is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.email.text == expectation end
...
Then /^[Ee]xpect Order Details form Domestic Ship-To fields are hidden$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times do break if stamps.orders.order_details.ship_to.domestic.text_area.present? == false end
...
Then /^[Ee]xpect Order Details form Customs Restrictions button is visible/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.customs.browser_restrictions_button.present? == true end
...
Then /^[Ee]xpect Order Details form Customs Restrictions button is hidden/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.customs.browser_restrictions_button.present? == false end
...
Then /^[Ee]xpect Order Details form Customs Edit Form button is visible/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.customs.browser_edit_form_button.present? == true end
...
Then /^[Ee]xpect Order Details form Customs Edit Form button is hidden/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.customs.browser_edit_form_button.present? == false end
...
Then /^[Ee]xpect Order Details form International Ship-To Name Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.name.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Company Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.company.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Address 1 Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.address_1.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Address 2 Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.address_2.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To City Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.city.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Province Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.province.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Postal Code Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.postal_code.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Phone Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.phone.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form International Ship-To Email Placeholder is (.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.international.email.placeholder == expectation end
...
Then /^[Ee]xpect Order Details form Panel is present$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.present? == true end
...
Then /^[Ee]xpect Order Details form Reference Number is (?:correct|(.*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.reference_no.text == expectation end
...
Then /^[Ee]xpect Order Details form Insure-For is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.insure_for.text_box.text.to_f.round(2) == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Insure-For Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  5.times do break if stamps.orders.order_details.insure_for.cost == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Insure-For Cost is greater than \$(.*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.insure_for.cost.to_f > expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form service \"(.*)\" is disabled/ do |service|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.disabled?(service) == true end
...
Then /^[Ee]xpect Order Details form service \"(.*)\" is enabled/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.enabled?(expectation) == true end
...
Then /^[Ee]xpect Order Details form Service Cost inline price for "([a-zA-Z -\/]+)" is greater than \$([0-9.]*)$/ do |service, expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.inline_cost(service).to_f >= expectation.to_f end
...
Then /^[Ee]xpect Order Details form Service Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.cost.to_f == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Service Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.cost > expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Tracking Cost is (?:correct|(\d+.\d*))$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.tracking.cost == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Tracking Cost is greater than \$([0-9.]*)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.tracking.cost.to_f > expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Pounds? (?:is (\d+)|and saved Pounds? are the same)$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.weight.lb.text_box.text.to_f == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Ounces? (?:is (\d+)|and saved Ounces? are the same)$/ do |expectation|
  ...
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.weight.oz.text_box.text.to_f == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Dimensions are hidden$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.dimensions.present? == false end
...
Then /^[Ee]xpect Order Details form Length is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.dimensions.length.text_box.text.to_f == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Width is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.dimensions.width.text_box.text.to_f == expectation.to_f.round(2) end
...
Then /^[Ee]xpect Order Details form Height is (\d+)$/ do |expectation|
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.dimensions.height.text_box.text.to_i == expectation.to_i end
...
And /^[Ee]xpect Order Details form Ship-To Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times do break if stamps.orders.order_details.ship_to.domestic.text_area.element.visible? == true end
...
And /^[Ee]xpect Order Details form Ship-To drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.country.drop_down.element.visible? == true end
...
And /^[Ee]xpect Order Details form Phone Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  stamps.orders.order_details.ship_to.domestic.show_address
  10.times do break if stamps.orders.order_details.ship_to.domestic.phone.element.visible? == true end
...
And /^[Ee]xpect Order Details form Email Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.ship_to.domestic.email.element.visible? == true end
...
And /^[Ee]xpect Order Details form Pounds Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.weight.lb.element.visible? == true end
...
And /^[Ee]xpect Order Details form Ounces Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.weight.oz.element.visible? == true end
...
And /^[Ee]xpect Order Details form service Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.text_box.element.visible? == true end
...
And /^[Ee]xpect Order Details form service drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.service.drop_down.element.visible? == true end
...
And /^[Ee]xpect Order Details form Insure-For Textbox is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.insure_for.text_box.element.visible? == true end
...
And /^[Ee]xpect Order Details form Tracking drop-down is enabled$/ do
  stamps.orders.order_details.wait_until_present(2)
  10.times do break if stamps.orders.order_details.tracking.drop_down.element.visible? == true end
