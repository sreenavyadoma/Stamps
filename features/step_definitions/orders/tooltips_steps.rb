...
Then /^[Ii]n Orders Toolbar, expect Print Tooltip to include (.*)$/ do |expectation|
  #SdcTest.log.step "In Orders Toolbar, expect Print Tooltip to include #{expectation}"
  actual=stamps.orders.orders_toolbar.toolbar_print.tooltip
  #SdcTest.log.step "Test #{(actual.include? expectation)?"Passed":"Failed"}"
  expect(actual).to include(expectation)
end

Then /^[Ii]n Orders Toolbar, expect Move Tooltip to include (.*)$/ do |expectation|
  #SdcTest.log.step "In Orders Toolbar, expect Move Tooltip to include #{expectation}"
...
Then /^[Ii]n Orders Toolbar, expect Add Tooltip to include (.*)$/ do |expectation|
  #SdcTest.log.step "In Orders Toolbar, expect Add Tooltip to include #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Toolbar Menu Tooltip is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Order Details Toolbar Menu Tooltip is #{expectation}"
...
Then /^Filter Panel: Menu Item collapse button tooltip should be (.*)$/ do |expectation|
  #SdcTest.log.step "Filter Panel: Menu Item collapse button tooltip should be #{expectation}"
...
Then /^Filter Panel: Menu Item expand button tooltip should be (.*)$/ do |expectation|
  #SdcTest.log.step "Filter Panel: Menu Item expand button tooltip should be #{expectation}"
...
Then /^Tooltips: Expect Print Modal Print Media \"(.*)\" tooltip to include \"(.*)\"$/ do |expectation, data_qtip|
  #SdcTest.log.step "Tooltips: Expect Print Modal Print Media #{expectation} tooltip to include #{data_qtip}"
  ...
  tooltips.each do |tooltip|
    #SdcTest.log.step "Test #{(actual_tooltip.include? tooltip)?"Passed":"Failed"}"
    expect(actual_tooltip).to include tooltip
  end
end

Then /^Tooltips: Expect Customs Tooltip Error for Total Weight is (.+)$/ do |expectation|
  #SdcTest.log.step "Tooltips: Expect Customs Tooltip Error for Total Weight is #{expectation}"
  ...
  #SdcTest.log.step "Test #{(data_error_qtip.include? expectation)?'Passed':'Failed'}"
...
Then /^[Oo]n Customs form, expect Associated Item Description Tooltip Error is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Customs Associated Item Description Tooltip Error is #{expectation}"
  stamps.common_modals.customs_form.should_not be_nil
...
Then /^[Oo]n Customs form, expect Qty Tooltip Error is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Customs Qty Tooltip Error is #{expectation}"
  stamps.common_modals.customs_form.should_not be_nil
...
Then /^[Oo]n Customs form, expect Unit Price Tooltip Error is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Customs Unit Price Tooltip Error is #{expectation}"
  stamps.common_modals.customs_form.should_not be_nil
...
Then /^[Oo]n Customs form, expect Pounds Tooltip Error is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Customs Pounds Tooltip Error is #{expectation}"
  stamps.common_modals.customs_form.should_not be_nil
...
Then /^[Oo]n Customs form, expect Ounces Tooltip Error is (.*)$/ do |expectation|
  #SdcTest.log.step "expect Customs Ounces Tooltip Error is #{expectation}"
  stamps.common_modals.customs_form.should_not be_nil
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Domestic Email data error tooltip is \"(.*)\"$/ do |expectation|
  ...
  data_error_tooltip=textbox.data_error_qtip
  #SdcTest.log.step "Test #{(data_error_tooltip.include? expectation)?"Passed":"Failed"}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Weight Lbs data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details Domestic  Weight lb data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Weight Oz data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details Weight Oz data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Dimensions Length data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details Dimensions Length data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Dimensions Width data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details Dimensions Width data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails Dimensions Height data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details Dimensions Height data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International Name data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International Name data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International Company data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International Company data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International Address 1 data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International Address 1 data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International City data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International City data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International Phone data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International Phone data error tooltip is #{expectation}"
...
Then /^[Ee]xpect [Oo]rder [Dd]etails International Email data error tooltip is \"(.*)\"$/ do |expectation|
  #SdcTest.log.step "expect Order Details International Email data error tooltip is #{expectation}"
