...
Then /^Orders Toolbar: Expect Print Tooltip to include (.*)$/ do |expectation|
  logger.step "Orders Toolbar: Expect Print Tooltip to include #{expectation}"
...
Then /^Orders Toolbar: Expect Move Tooltip to include (.*)$/ do |expectation|
  logger.step "Orders Toolbar: Expect Move Tooltip to include #{expectation}"
  actual = stamps.orders.toolbar.move.tooltip
  logger.step "Test #{(actual.include? expectation)?"Passed":"Failed"}"
  actual.should include expectation
end

Then /^Orders Toolbar: Expect Add Tooltip to include (.*)$/ do |expectation|
  logger.step "Orders Toolbar: Expect Add Tooltip to include #{expectation}"
  actual = stamps.orders.toolbar.add.order_details.tooltip
  logger.step "Test #{(actual.include? expectation)?"Passed":"Failed"}"
  actual.should include expectation
end

Then /^Order Details: Expect Toolbar Menu Tooltip is (.*)$/ do |expectation|
  logger.step "Order Details: Expect Toolbar Menu Tooltip is #{expectation}"
...
Then /^Customs Form: Expect Item Description Tooltip Error is (.*)$/ do |expectation|
  logger.step "Customs Form: Expect Item Description Tooltip Error is #{expectation}"
  stamps.orders.order_details.customs.edit_form.should_not be_nil
...
Then /^Customs Form: Expect Qty Tooltip Error is (.*)$/ do |expectation|
  logger.step "Customs Form: Expect Qty Tooltip Error is #{expectation}"
  stamps.orders.order_details.customs.edit_form.should_not be_nil
...
Then /^Customs Form: Expect Unit Price Tooltip Error is (.*)$/ do |expectation|
  logger.step "Customs Form: Expect Unit Price Tooltip Error is #{expectation}"
  stamps.orders.order_details.customs.edit_form.should_not be_nil
...
Then /^Customs Form: Expect Pounds Tooltip Error is (.*)$/ do |expectation|
  logger.step "Customs Form: Expect Pounds Tooltip Error is #{expectation}"
  stamps.orders.order_details.customs.edit_form.should_not be_nil
...
Then /^Customs Form: Expect Ounces Tooltip Error is (.*)$/ do |expectation|
  logger.step "Customs Form: Expect Ounces Tooltip Error is #{expectation}"
  stamps.orders.order_details.customs.edit_form.should_not be_nil
...
Then /^Order Details: Expect Domestic Address data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Domestic Address data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Domestic Email data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Domestic Email data error tooltip is #{expectation}"
  stamps.orders.order_details.ship_to.domestic.show_address
...
Then /^Order Details: Expect Weight Lbs data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Domestic  Weight lb data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Weight Oz data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Weight Oz data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Service data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Weight Oz data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Dimensions Length data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Dimensions Length data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Dimensions Width data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Dimensions Width data error tooltip is #{expectation}"
...
Then /^Order Details: Expect Dimensions Height data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect Dimensions Height data error tooltip is #{expectation}"
...
Then /^Orders Grid: Expect ship cost data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Orders Grid: Expect ship cost data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International Name data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International Name data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International Company data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International Company data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International Address 1 data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International Address 1 data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International City data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International City data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International Phone data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International Phone data error tooltip is #{expectation}"
...
Then /^Order Details: Expect International Email data error tooltip is \"(.*)\"$/ do |expectation|
  logger.step "Order Details: Expect International Email data error tooltip is #{expectation}"
