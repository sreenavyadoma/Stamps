Then /^Verify Local Rating$/ do |table|
  #SdcTest.log.step "Verify Local Rating..."
  ...
  parameter_array.each_with_index do |field, index|
    #SdcTest.log.step "  --------------------------------------------------------------------------- "
    #SdcTest.log.step "  Test #{index}  ||  #{field["ship_from"]} ||  #{field["ship_to"]} ||  #{field["weight_oz"]} ||  #{field["weight_lb"]} ||  #{field["length"]} ||  #{field["height"]} ||  #{field["width"]} ||  #{field["service"]} ||  #{field["tracking"]}"
    #SdcTest.log.step "  --------------------------------------------------------------------------- "
    ...
    #SdcTest.log.step "  --------------------------------------------------------------------------- "
    #SdcTest.log.step "  Test #{index} #{(results[index])?"Passed":"Failed"}"
    #SdcTest.log.step "  --------------------------------------------------------------------------- "
