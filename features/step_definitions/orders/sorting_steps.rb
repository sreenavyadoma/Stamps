...
Then /^In Orders Grid, Sort service in Ascending Order$/ do
...
Then /^In Orders Grid, Sort service in Descending Order$/ do
...
Then /^In Orders Grid, Sort Order ID in Ascending Order$/ do
...
Then /^In Orders Grid, Sort Order ID in Descending Order$/ do
