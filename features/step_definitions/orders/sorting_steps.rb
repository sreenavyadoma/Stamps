...
Then /^Orders Grid: Sort Service in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.service.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Service in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Service in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.service.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Service in Descending Order"
  sort_order.should eql "DESC"
end
Then /^Orders Grid: Sort Order ID in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.order_id.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Order ID in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.order_id.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Store: Sort in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.store.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Store: Sort in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.store.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort Age in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.age.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Age in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.age.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort Order Date in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.order_date.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Order Date in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.order_date.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort Recipient in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.recipient.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Recipient in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.recipient.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort Company in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.company.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Company in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.company.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort Address in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.address.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort Address in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.address.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort City in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.city.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort City in Descending Order$/ do
  sort_order = stamps.orders.orders_grid.column.city.sort_descending
  logger.step "Step #{(sort_order=="DESC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Descending Order"
  sort_order.should eql "DESC"
end

Then /^Orders Grid: Sort State in Ascending Order$/ do
  sort_order = stamps.orders.orders_grid.column.state.sort_ascending
  logger.step "Step #{(sort_order=="ASC")?'Passed':'Failed'} - Orders Grid: Sort Order ID in Ascending Order"
  sort_order.should eql "ASC"
end

Then /^Orders Grid: Sort State in Descending Order$/ do
  logger.step ""
