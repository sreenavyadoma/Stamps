...
Then /^[Ee]xect [Oo]rder [Dd]etails form Order ID is the same as saved Order ID$/ do
...
Then /^[Ii]n [Nn]ew [Rr]ule [Mm]odal, [Ss]et Rule name to (.*)$/ do |value|
...
Then /^[Ee]xpect [Aa]utomation [Rr]ules modal, Rule name present$/ do ||
