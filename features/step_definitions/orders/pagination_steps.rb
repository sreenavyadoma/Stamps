...
Then /^(?:E|e)xpect page toolbar First Page is (\w+)$/  do |expectation|
...
Then /^(?:E|e)xpect page toolbar Previous Page is (\w+)$/  do |expectation|
...
Then /^(?:E|e)xpect page toolbar Page Number is (\w+)$/  do |expectation|
...
Then /^(?:E|e)xpect page toolbar Next Page is (\w+)$/  do |expectation|
...
Then /^(?:E|e)xpect page toolbar Last Page is (\w+)$/  do |expectation|
...
When /^(?:S|s)et Page Number to (\d*)$/ do |value|
