Feature:  International and APO/FPO Printing (CN22 and CP72)
  ...
  Scenario:
    ...
    And Add Customs Form Item 2; Description=random, Qty 1, Unit Price 3000, Weight(lbs) 1, Weight(oz) 1 Origin United States, Tariff 10
    Then Expect Customs Form Item Grid count to be 2
    And Add Customs Form Item 3; Description=random, Qty 1, Unit Price 100, Weight(lbs) 1, Weight(oz) 1 Origin United States, Tariff 10
