Feature:  History regression
  ...
  Scenario: Label Cost is hidden for container label
    ...
    Then expand services on print details
    Then expect service cost on print details is present
    ...
    Then select row 1 on history grid
    Then expand services on print details
    Then expect service cost on print details is not present
    Then sign out