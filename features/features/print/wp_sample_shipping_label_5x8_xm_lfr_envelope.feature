Feature: Postage Sample Shipping Label - 5 ½” x 8 ½” - XM Legal Flat Rate Envelope
  ...
  @wp_sample_shipping_label_5x8_xm_lfr_envelope
  Scenario: Sample Shipping Label - 5 ½” x 8 ½” - XM Legal Flat Rate Envelope
