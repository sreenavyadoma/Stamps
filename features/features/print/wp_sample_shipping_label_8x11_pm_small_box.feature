Feature: Postage Sample Shipping Label - 8 ½” x 11” Paper - PM Small Flat Rate Box
  ...
  @wp_sample_shipping_label_8x11_pm_small_box
  Scenario: Sample Shipping Label - 8 ½” x 11” Paper - PM Small Flat Rate Box
    ...
    Then Postage Shipping Labels: Select Service Priority Mail Small Flat Rate Box
