Feature: Postage Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
  ...
  @wp_shipping_label_sdc1200_xm_lfr_envelope
  Scenario: Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
