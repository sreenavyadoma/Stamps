Feature: Postage Shipping Label - 8 ½” x 11” Paper - PM Large/Thick Envelope
  ...
  @wp_shipping_label_8x11_pm_large_envelope
  Scenario: Shipping Label - 8 ½” x 11” Paper - PM Large/Thick Envelope
    ...
    Then Postage Shipping Labels: Select Service Priority Mail Large-Thick Envelope
