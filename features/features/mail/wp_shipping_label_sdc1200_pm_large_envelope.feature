Feature: Postage Shipping Label - SDC-1200 - PM Large/Thick Envelope
  ...
  @wp_shipping_label_sdc1200_pm_large_envelope
  Scenario: Shipping Label - SDC-1200 - PM Large/Thick Envelope
