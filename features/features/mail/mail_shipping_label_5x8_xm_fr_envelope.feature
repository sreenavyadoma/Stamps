Feature: Mail Shipping Label - 5 ½” x 8 ½” - XM Flat Rate Envelope
  ...
  Scenario: Shipping Label - 5 ½” x 8 ½” - XM Flat Rate Envelope
    ...
    Then on Print form, select service Priority Mail Express Flat Rate Envelope
