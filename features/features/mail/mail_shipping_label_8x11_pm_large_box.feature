Feature: Mail Shipping Label - 8 ½” x 11” Paper - Large Box
  ...
  Scenario: Shipping Label - 8 ½” x 11” Paper - PM Large Box
    ...
    Then on Shipping Label Print form, select service Priority Mail Large Flat Rate Box
