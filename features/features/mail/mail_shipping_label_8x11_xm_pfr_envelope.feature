Feature: Mail Sample Shipping Label - 8 ½” x 11” Paper - XM Padded Flat Rate Envelope
  ...
  Scenario: Sample Shipping Label - 8 ½” x 11” Paper - XM Padded Flat Rate Envelope
    ...
    Then on Shipping Label Print form, select service Priority Mail Express Padded Flat Rate Envelope
