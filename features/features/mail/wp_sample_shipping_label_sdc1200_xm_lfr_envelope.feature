Feature: Postage Sample Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
  ...
  @wp_sample_shipping_label_sdc1200_xm_lfr_envelope
  Scenario: Sample Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
    ...
    Then Postage Shipping Labels: Select Service Priority Mail Express Legal Flat Rate Envelope
