Feature: Mail Sample Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
  ...
  Scenario: Sample Shipping Label - SDC-1200 - XM Legal Flat Rate Envelope
    ...
    Then on Print form, select service Priority Mail Express Legal Flat Rate Envelope
