Feature: Mail Shipping Label - 8 ½” x 11” Paper - FCM Large Envelope
  ...
  Scenario: Shipping Label - 8 ½” x 11” Paper - FCM Large Envelope
    ...
    Then on Shipping Label Print form, select service First-Class Mail Large Envelope-Flat
