Feature: Mail Shipping Label - SDC-1200 - PM Legal Flat Rate Envelope
  ...
  Scenario: Shipping Label - SDC-1200 - PM Legal Flat Rate Envelope
    ...
    Then on Print form, select service Priority Mail Legal Flat Rate Envelope
