Feature: WebReg Membership page validation Theme 1632
  ...
  Scenario: Theme 1632
    ...
    #Then expect WebReg Membership Billing address same as mailing address checkbox exists and is checkmarked
    #Then expect WebReg Membership I agree to the Terms and conditions and Pricing details checkbox exists and is checkmarked
