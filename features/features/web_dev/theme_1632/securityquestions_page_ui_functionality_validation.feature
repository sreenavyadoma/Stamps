Feature: Registration Security questions page validation theme_1632
  ...
  Scenario:
    Then set Registration Profile email to email
    Then set Registration Profile username to username
    Then set Registration Profile password to password
    Then set Registration Profile retype password textbox to password
    Then set Registration Profile Usage Type list of values to contain Business Use - Mostly mailing (letters/postcards/flats
    Then on Registration Profile page, continue to Membership page
    ...
    Then expect Registration Profile Privacy Policy link exists
