...
Feature:  As a batch shipper, I want to be able to print multiple labels
  ...
  Scenario: User Prints 3 Domestic labels on SDC-1200 - left side
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PM Med FR Box, SDC-1200, 530 K Street Unit 504, San Diego CA 92101-7060
    Then Set Order Form Service to "Priority Mail Medium Flat Rate Box"
    And I Add a second order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PM Lg FR Box, SDC-1200, 7065 N Ingram Ave, Fresno CA 93650-1083
    Then Set Order Form Service to "Priority Mail Large Flat Rate Box"
    And I Add a third order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PM RR Box A, SDC-1200, 4937 79th St., Sacramento CA 95820-6213
  ...
  Scenario: User Prints 1 Intl CP72, 2 Intl CN22 labels on 8.5x11 - left side
    ...
    Then Set Order Form Service to "Priority Mail International Small Flat Rate Box"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Form Service to "Priority Mail International Medium Flat Rate Box"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Form Service to "Priority Mail Express International Package"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 3 Domestic, 3 Intl CP72 labels on 8.5x11 - left side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PME FR Envelope, 5.5x8.5, 26930 NE 152nd St., Duvall WA 98019-8316
    Then Set Order Form Service to "Priority Mail Express Flat Rate Envelope"
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PME LFR Envelope, 5.5x8.5, 2105 Kietzke Ln, Reno NV 89502-3602
    Then Set Order Form Service to "Priority Mail Express Legal Flat Rate Envelope"
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PME PFR Envelope, 5.5x8.5, 557 County Rd. H, Fredonia WI 53021-9634
    ...
    Then Set Order Form Service to "Priority Mail International Large Flat Rate Box"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Form Service to "Priority Mail Express International Flat Rate Envelope"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Domestic label on 5.5x8.5 - left side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PME MFR Box, 5.5x8.5, 2775 Stark Dr., Willoughby Hills OH 44094-9113
  ...
  Scenario: User Prints 1 Domestic label on 5.5x8.5 - right side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PS Package, 5.5x8.5 Right Side 1, 610 W Tefft St, Nipomo, CA 93444-9187
    Then Set Order Form Service to "Parcel Select Package"
    Then Open Print Modal
    Then Select Print Media "Shipping Label - 5 ½" x 8 ½""
    Then Select right side label
    Then Expect right side label selected
  ...
  Scenario: User Prints 2 Domestic labels on 5.5x8.5 - left side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PS Large Package, 5.5x8.5, 530 K Street Unit 504, San Diego CA 92101-7060
    Then Set Order Form Service to "Parcel Select Large Package"
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PS Large Package, 5.5x8.5, 7065 N Ingram Ave, Fresno CA 93650-1083
    Then Set Order Form Service to "Parcel Select Oversized Package"
    Then Edit row 1 on the order grid
    Then Edit row 2 on the order grid
    Then Open Print Modal
    Then Select Print Media "Shipping Label - 5 ½" x 8 ½""
  ...
  Scenario: User Prints 2 Domestic labels on 5.5x8.5 - right side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PM Large Package, 5.5x8.5 Right Side 1, 26930 NE 152nd St., Duvall WA 98019-8316
  ...
  Scenario: User Prints 3 Domestic labels on 5.5x8.5 - left side
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to FCM Lg Env-Flat, 5.5x8.5, 2105 Kietzke Ln, Reno NV 89502-3602
    Then Set Order Form Service to "First-Class Mail Large Envelope/Flat"
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to PM Lg-Thick Env, 5.5x8.5, 557 County Rd. H, Fredonia WI 53021-9634
    ...
    And I Add a new order
    Then Set Order Form Ship-From to default
    Then Set Order Form Ship-To address to FCM Pkg-Thick Env, 5.5x8.5, 2775 Stark Dr., Willoughby Hills OH 44094-9113
    Then Set Order Form Service to "First-Class Mail Package/Thick Envelope"
    Then Edit row 1 on the order grid
    Then Edit row 2 on the order grid
    Then Edit row 3 on the order grid
    Then Open Print Modal
  ...
  Scenario: User Prints 1 Intl CP72 label on 5.5x8.5 - left side
    ...
    Then Set Order Form Service to "Priority Mail Express International Legal Flat Rate Envelope"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CP72 label on 5.5x8.5 - right side
    ...
    Then Set Order Form Service to "Priority Mail Express International Padded Flat Rate Envelope"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CN22, 1 Intl CP72 label on SDC-1200 - left side
    ...
    Then Set Order Form Service to "Priority Mail Express International Flat Rate Box"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Form Service to "First-Class Mail International Envelope"
    Then Set Order Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
