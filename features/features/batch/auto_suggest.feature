...
Feature: As a batch shipper, I want to be able to use auto suggest to fill out address forms [B-01607]
  ...
  Scenario: Select Domestic Address
    ...
    Then Set Order Form Pounds to 0
    ...
    Then Set Order Form Ship-To address to 794
    ...
    Then Set Order Form Ship-To address to 591
    ...
    Then Set Order Form Ship-To address to 330
    ...
    Then Set Order Form Ship-To address to Uni
