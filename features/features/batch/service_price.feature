...
Feature: User Views Price Next to Service Dropdown
  ...
  Scenario:  User Views Price Next to Service Dropdown
    ...
    Then Expect single-order form Service Cost inline price for "First-Class Mail Large Envelope/Flat" to be greater than $0.01
    Then Expect single-order form Service Cost inline price for "First-Class Mail Package/Thick Envelope" to be greater than $0.01
