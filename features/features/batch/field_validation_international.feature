Feature: International Field Validation
  ...
  Scenario: Add Missing Validation Logic for Phone and International Email
    ...
    Then Expect Order Form International Name data error tooltip to be "A First Name and Last Name or Company are required"
    Then Set International Ship-To company to ""
    Then Expect Order Form International Company data error tooltip to be "A First Name and Last Name or Company are required"
    Then Set International Ship-To address 1 to ""
    Then Expect Order Form International Address 1 data error tooltip to be "The ship to address is a required field"
    Then Set International Ship-To city to ""
    Then Expect Order Form International City data error tooltip to be "The ship to city is a required field"
    Then Set International Ship-To phone to ""
    Then Expect Order Form International Phone data error tooltip to be "The ship to phone number is a required field"
    Then Set International Ship-To email to "@@"
    Then Set Order Form Service to "First-Class Mail International Large Envelope/Flat"
    Then Expect Order Form International Email data error tooltip to be "Please enter a valid email address"
