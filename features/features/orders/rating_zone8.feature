Feature: Local Rating test for zone 8
  ...
  Scenario:  All Services
    ...
    Then Details: Expect Total is $52.31
    ...
    Then Details: Expect Total is $78.80
    ...
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total is $274.05
