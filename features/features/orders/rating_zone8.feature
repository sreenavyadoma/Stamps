Feature: Local Rating test for zone 8
  ...
  Scenario:  All Services
    ...
    Then Expect Order Details Total to be $3.62
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Expect Order Details Total to be $63.49
    ...
    Then Expect Order Details Total to be $52.31
    ...
    Then Expect Order Details Total to be $78.80
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Expect Order Details Total to be $274.05
