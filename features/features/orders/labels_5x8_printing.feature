...
Feature: I want to be able to print to 5.5 x 8.5 labels (single or multi) B-01667
  ...
  Scenario:  User prints postage for CN22 Shipping Label 5.5 x 8.5
    ...
    And Add Customs Form Item 1 - Description random, Qty 1, Price 20, Lbs 0, Oz 5 Origin United States, Tariff 10
    Then Open Print Modal
    Then Set Print Modal Media "Shipping Label - 5 ½" x 8 ½""
    Then Print
    And Sign out
  ...
  Scenario:  User prints postage for CP72 Shipping Label 5.5 x 8.5
    ...
    Then Set Order Details Length to 1
    And Open customs form
    And Add Customs Form Item 1 - Description random, Qty 1, Price 20, Lbs 1, Oz 0 Origin United States, Tariff 10
