Feature: Local Rating test for zone 1
  ...
  Scenario:  All Services
    ...
    Then Order Details: Set Tracking to "Signature Required"
    Then Expect Order Details Total to be $13.22
    ...
    Then Order Details: Set Tracking to "Signature Required"
    Then Expect Order Details Total to be $8.55
    ...
    Then Order Details: Set Tracking to "Signature Required"
    Then Expect Order Details Total to be $18.80
