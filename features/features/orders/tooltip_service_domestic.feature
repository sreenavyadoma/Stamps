...
Feature: service Tooltip
  ...
  Scenario: International service Tooltip Tests
    ...
    Then expect Order Details form service Tooltip for "Priority Mail Express International Package" to include "Ship up to 70 lb. using any thick envelope or box with pricing that varies by weight and country. The USPS provides free packaging for Priority Mail Express which can be ordered from Stamps.com.||Packaging requirements:||Length + 2x width + 2x height cannot exceed 108" (some countries have further restrictions)"
    Then expect Order Details form service Tooltip for "Priority Mail Express International Flat Rate Envelope" to include "Ship up to 4 lb. with pricing that varies by country, not weight.  You must use the 9 1/2" x 12 1/2" USPS-provided envelope which can be ordered for free from Stamps.com."
    Then expect Order Details form service Tooltip for "Priority Mail Express International Padded Flat Rate Envelope" to include "Ship up to 4 lb. with pricing that varies by country, not weight.  You must use the 9 1/2" x 12 1/2" USPS-provided padded envelope which can be ordered for free from Stamps.com."
  ...
  Scenario: Domestic service Tooltip Tests
    ...
    Then expect Order Details form service Tooltip for "Priority Mail Express Package" to include "Ship up to 70 lb. using any box or envelope with pricing that varies by weight and distance. The USPS provides free packaging for Priority Mail Express which can be ordered from Stamps.com.||Packaging requirements:||Length + 2x width + 2x height cannot exceed 108""
    Then expect Order Details form service Tooltip for "Priority Mail Express Flat Rate Envelope" to include "Ship up to 70 lb. to anywhere in the U.S. for one low rate.  You must use the 9 1/2" x 12 1/2" USPS-provided envelope which can be ordered for free from Stamps.com."
    Then expect Order Details form service Tooltip for "Priority Mail Express Padded Flat Rate Envelope" to include "Ship up to 70 lb. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 12 1/2"padded envelope which can be ordered for free from Stamps.com."
    Then expect Order Details form service Tooltip for "Priority Mail Express Legal Flat Rate Envelope" to include "Ship up to 70 lb. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 15" envelope which can be ordered for free from Stamps.com."
