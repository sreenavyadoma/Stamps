...
Feature: As a batch shipper, I want to be able to use auto suggest to fill out address forms [B-01607]
  ...
  Scenario: Select Domestic Address
    ...
    Then Order Details: Set Ship-To address to 794
    ...
    Then Order Details: Set Ship-To address to 591
    ...
    Then Order Details: Set Ship-To address to 330
    ...
    Then Order Details: Set Ship-To address to Uni
