...
Feature: Service Tooltip
  ...
  Scenario: Domestic Service Tooltip Tests
    ...
    Then Order Details: Expect Service Tooltip for "Priority Mail Large/Thick Envelope" to include "Ship up to 70 lbs. using any large or thick envelope with pricing that varies by weight and distance. The USPS provides free packaging for Priority Mail, which can be ordered from Stamps.com.||Envelope requirements:||Length + 2x width + 2x height cannot exceed 84""
    Then Order Details: Expect Service Tooltip for "Priority Mail Package" to include "Ship up to 70 lbs. using any box with pricing that varies by weight and distance. The USPS provides free packaging for Priority Mail which can be ordered from Stamps.com.||Packaging requirements:||Length + 2x width + 2x height cannot exceed 84""
    Then Order Details: Expect Service Tooltip for "Priority Mail Large Package" to include "Ship up to 70 lbs. using any large box with pricing that varies by weight and distance. The USPS provides free packaging for Priority Mail which can be ordered from Stamps.com.||Packaging requirements:||Length + 2x width + 2x height must be over 84" and less than 108""
    Then Order Details: Expect Service Tooltip for "Priority Mail Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use a USPS-provided envelope which can be ordered for free from Stamps.com.||Available envelope sizes:||Standard:	9 1/2" x 12 1/2"||Gift Card: 	7" x 10"||Windowed: 	5" x 10"||Small:		6" x 10""
    Then Order Details: Expect Service Tooltip for "Priority Mail Padded Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 12 1/2"padded envelope which can be ordered for free from Stamps.com."
    Then Order Details: Expect Service Tooltip for "Priority Mail Legal Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 15" envelope which can be ordered for free from Stamps.com."
    Then Order Details: Expect Service Tooltip for "Priority Mail Small Flat Rate Box" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 8 11/16" x 5 7/16" x 1 3/4" box which can be ordered for free from Stamps.com."
    ...
    Then Order Details: Expect Service Tooltip for "Priority Mail Large Flat Rate Box" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use a USPS-provided box which can be ordered for free from Stamps.com.||Available box sizes:||Standard: 12 1/4" x 12 1/4" x 6||"
    Then Order Details: Expect Service Tooltip for "Priority Mail Regional Rate Box A" to include "Ship up to 15 lbs. anywhere in the U.S. with pricing that varies by distance, not weight.  You must use a USPS-provided box which can be ordered for free from Stamps.com.||Available box sizes:||Top Loading:10 1/8" x 7 1/8" x 5"||Side Loading: 13 1/16" x 11 1/16" x 2 1/2""
    Then Order Details: Expect Service Tooltip for "Priority Mail Regional Rate Box B" to include "Ship up to 20 lbs. anywhere in the U.S. with pricing that varies by distance, not weight.  You must use a USPS-provided box which can be ordered for free from Stamps.com.||Available box sizes:||Top Loading: 	12 1/4" x 10 1/2" x 5 1/2" ||Side Loading:	16 1/4" x 14 1/2" x 3""

    Then Order Details: Expect Service Tooltip for "Priority Mail Express Package" to include "Ship up to 70 lbs. using any box or envelope with pricing that varies by weight and distance. The USPS provides free packaging for Priority Mail Express which can be ordered from Stamps.com.||Packaging requirements:||Length + 2x width + 2x height cannot exceed 108""
    Then Order Details: Expect Service Tooltip for "Priority Mail Express Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the 9 1/2" x 12 1/2" USPS-provided envelope which can be ordered for free from Stamps.com."
    Then Order Details: Expect Service Tooltip for "Priority Mail Express Padded Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 12 1/2"padded envelope which can be ordered for free from Stamps.com."
    Then Order Details: Expect Service Tooltip for "Priority Mail Express Legal Flat Rate Envelope" to include "Ship up to 70 lbs. to anywhere in the U.S. for one low rate.  You must use the USPS-provided 9 1/2" x 15" envelope which can be ordered for free from Stamps.com."

    Then Order Details: Expect Service Tooltip for "Media Mail Package" to include "Ship up to 70 lbs. using your own thick envelope or box with pricing that varies by weight, not distance.||Packaging requirements:||Length + 2x width + 2x height cannot exceed 108""

    Then Order Details: Expect Service Tooltip for "Parcel Select Ground Package" to include "Ship up to 70 lbs. using your own thick envelope or box with pricing that varies by weight and distance. ||Packaging requirements:||Length + 2x width + 2x height must be less than 84""
    Then Order Details: Expect Service Tooltip for "Parcel Select Ground Large Package" to include "Ship up to 70 lbs. using your own large box with pricing that varies by weight and distance. ||Packaging requirements:||Length + 2x width + 2x height must be over 84""
    Then Order Details: Expect Service Tooltip for "Parcel Select Ground Oversized Package" to include "Ship up to 70 lbs. using your own oversized box with pricing that varies by weight and distance. ||Packaging requirements:||Length + 2x width + 2x height must be over 108" and less than 130""
