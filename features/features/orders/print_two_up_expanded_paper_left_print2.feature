Feature: Print 2 Domestic labels on 8.5x11 - left side
  ...
  Scenario: Print 2 Domestic labels on 8.5x11 - left side
    ...
    Then Details: Set Ship-To to Domestic Address PM FR Envelope, 8.5x11, 2105 Kietzke Ln, Reno NV 89502-3602
    Then Details: Select Service Priority Mail Flat Rate Envelope
    Then Details: Set Ounces to 1
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To to Domestic Address PM PFR Envelope, 8.5x11, 557 County Rd. H, Fredonia WI 53021-9634
