Feature: Local Rating test for zone 2
  ...
  Scenario:  All Services
    ...
    Then Order Details: Expect Total to be $1.64
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $13.26
