Feature: January 2017 Rates for Core User in Zone 7
  ...
  Scenario: Priority Mail Regional Rate Box A
    ...
    Then set Order Details form Weight to 10 lb 1 oz
    Then expect Order Details form Service Cost is 9.99
    Then set Order Details form Tracking to USPS Tracking
    Then expect Order Details form Total Ship Cost is 9.99
  ...
  Scenario: Priority Mail Regional Rate Box B
    ...
    Then set Order Details form Weight to 30 lb 1 oz
    Then expect Order Details form Service Cost is 17.93
    Then set Order Details form Tracking to USPS Tracking
    Then expect Order Details form Total Ship Cost is 17.93
