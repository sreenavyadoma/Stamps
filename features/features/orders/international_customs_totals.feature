Feature:  Customs Form Totals
  ...
  Scenario:  Customs Form Grid - Add Items
    ...
    And Add Customs Form Item 1; Description=random, Qty 1, Unit Price 100.50, Weight(lbs) 1, Weight(oz) 1 Origin Zimbabwe, Tariff 100
    ...
    And Add Customs Form Item 2; Description=random, Qty 1, Unit Price 100.25, Weight(lbs) 1, Weight(oz) 1 Origin Afghanistan, Tariff 100
