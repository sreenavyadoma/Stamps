Feature: Local Rating test for zone 6
  ...
  Scenario:  All Services
    ...
    Then Order Details: Expect Total to be $3.40
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $52.60
    ...
    Then Order Details: Expect Total to be $26.21
    ...
    Then Order Details: Expect Total to be $62.85
    ...
    Then Order Details: Set Weight to 23 lbs 0 oz
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $116.24
