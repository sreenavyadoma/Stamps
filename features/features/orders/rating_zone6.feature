Feature: Local Rating test for zone 6
  ...
  Scenario:  All Services
    ...
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total is $52.60
    ...
    Then Details: Expect Total is $26.21
    ...
    Then Details: Expect Total is $62.85
    ...
    Then Details: Set Weight to 23 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total is $116.24
