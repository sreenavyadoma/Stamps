...
Feature: Order Pagination
  ...
  Background:
    Given I am signed in to Orders as ff/qacc/webbatch_0009/password1
  ...
  #Scenario: Go to Next, Last, Previous and First Pages
    ...
    Then Pagination control to go to next page is enabled
    ...
    Then Pagination control to go to previous page is enabled
  ...
  #Scenario: Go to Specific Page Number
    ...
    Then Pagination control to go to page number is enabled
