Feature: Local Rating test for zone 7
  ...
  Scenario:  All Services
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $64.26
    ...
    Then Order Details: Expect Total to be $31.92
    ...
    Then Order Details: Expect Total to be $73.93
    ...
    Then Order Details: Set Weight to 22 lbs 1 oz
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $122.31
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $105.48
