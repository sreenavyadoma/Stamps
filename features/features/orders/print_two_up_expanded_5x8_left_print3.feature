Feature: Print 3 Domestic labels on 5.5x8.5 - left side
  ...
  Scenario: Print 3 Domestic labels on 5.5x8.5 - left side
    ...
    Then Details: Set Ship-To text area to FCM Lg Env-Flat, 5.5x8.5, 2105 Kietzke Ln, Reno NV 89502-3602
    Then Details: Select Service First-Class Mail Large Envelope/Flat
    Then Details: Set Ounces to 1
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To text area to PM Lg-Thick Env, 5.5x8.5, 557 County Rd. H, Fredonia WI 53021-9634
    ...
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To text area to FCM Pkg-Thick Env, 5.5x8.5, 2775 Stark Dr., Willoughby Hills OH 44094-9113
