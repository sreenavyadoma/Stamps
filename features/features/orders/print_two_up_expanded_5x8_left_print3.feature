Feature: Print 3 Domestic labels on 5.5x8.5 - left side
  ...
  Scenario: Print 3 Domestic labels on 5.5x8.5 - left side
    ...
    Then Details: Set Ship-To to Domestic Address FCM Lg Env-Flat, 5.5x8.5, 2105 Kietzke Ln, Reno NV 89502-3602
    ...
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To to Domestic Address FCM Pkg-Thick Env, 5.5x8.5, 2775 Stark Dr., Willoughby Hills OH 44094-9113
