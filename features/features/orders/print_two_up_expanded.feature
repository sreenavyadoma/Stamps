...
Feature:  As a batch shipper, I want to be able to print multiple labels
  ...
  Scenario: User Prints 1 Domestic label on SDC-1200 - right side
    ...
    Then Set Order Details Form Insured Value to $1.09
    Then Open Print Modal
  ...
  Scenario: User Prints 2 Intl CN22 labels on 8.5x11 - right side
    ...
    Then Set Order Details Form Service to "Priority Mail International Padded Flat Rate Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Details Form Service to "Priority Mail International Legal Flat Rate Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CP72, 2 Intl CN22 labels on 8.5x11 - left side
    ...
    Then Set Order Details Form Service to "Priority Mail International Small Flat Rate Box"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Details Form Service to "Priority Mail International Medium Flat Rate Box"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Details Form Service to "Priority Mail Express International Package"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 3 Domestic, 3 Intl CP72 labels on 8.5x11 - left side
    ...
    Then Set Order Details Form Service to "Priority Mail International Large Flat Rate Box"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
    ...
    Then Set Order Details Form Service to "Priority Mail Express International Flat Rate Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CP72 label on 5.5x8.5 - left side
    ...
    Then Set Order Details Form Service to "Priority Mail Express International Legal Flat Rate Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CP72 label on 5.5x8.5 - right side
    ...
    Then Set Order Details Form Service to "Priority Mail Express International Padded Flat Rate Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 1 Intl CN22, 1 Intl CP72 label on SDC-1200 - left side
    ...
    Then Set Order Details Form Service to "First-Class Mail International Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
  ...
  Scenario: User Prints 2 Intl CN22 labels on 5.5x8.5 - right side
    ...
    Then Set Order Details Form Service to "First-Class Mail International Package/Thick Envelope"
    Then Set Order Details Form Ounces to 1
    And Open customs form
    Then Set customs form Package Contents to "Merchandise"
    And Add or Edit Customs Form Item 1; Description=random, Qty 1, Unit Price 30, Weight(lbs) 0, Weight(oz) 1 Origin United States, Tariff 10
