Feature: Local Rating test for zone 5
  ...
  Scenario:  All Services
    ...
    Then Order Details: Expect Total to be $1.86
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $6.20
    ...
    Then Order Details: Expect Total to be $22.78
    ...
    Then Order Details: Expect Total to be $42.61
    ...
    Then Order Details: Set Tracking to "USPS Tracking"
    Then Order Details: Expect Total to be $50.13
