Feature: Local Rating test for zone 5
  ...
  Scenario:  All Services
    ...
    Then Details: Expect Total is $22.78
    ...
    Then Details: Expect Total is $42.61
    ...
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total is $50.13
