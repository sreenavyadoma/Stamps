...
Feature: As a batch shipper, I want to be able to use auto suggest to fill out address forms [B-01607]
  ...
  Background:
    Given I am signed in to Orders as autosuggest/password1
  ...
  Scenario: Select Domestic Address
    ...
    Then Set Order Details Ship-To partial address to san
    ...
    Then Set Order Details Ship-To address to 794
    ...
    Then Set Order Details Ship-To address to 591
    ...
    Then Set Order Details Ship-To address to 330
    ...
    Then Set Order Details Ship-To address to Uni
