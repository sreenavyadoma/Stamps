Feature: User Prints 3 Domestic labels on SDC-1200 - left side
  ...
  Scenario: User Prints 3 Domestic labels on SDC-1200 - left side
    ...
    Then Details: Set Ship-To address text area to PM Med FR Box, SDC-1200, 530 K Street Unit 504, San Diego CA 92101-7060
    Then Details: Select Service Priority Mail Medium Flat Rate Box
    Then Details: Set Ounces to 1
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To address text area to PM Lg FR Box, SDC-1200, 7065 N Ingram Ave, Fresno CA 93650-1083
    Then Details: Select Service Priority Mail Large Flat Rate Box
    Then Details: Set Ounces to 1
    Then Toolbar: Add
    Then Details: Set Ship-From to default
    Then Details: Set Ship-To address text area to PM RR Box A, SDC-1200, 4937 79th St., Sacramento CA 95820-6213
