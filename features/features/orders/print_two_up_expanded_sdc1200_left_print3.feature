Feature: User Prints 3 Domestic labels on SDC-1200 - left side
  ...
  Scenario: User Prints 3 Domestic labels on SDC-1200 - left side
    ...
    Then set Order Details form Ship-To to Domestic Address PM Med FR Box, SDC-1200, 530 K Street Unit 504, San Diego CA 92101-7060
    Then on Order Details form, select service PM Medium Flat Rate Box
    Then set Order Details form Ounces to 1
    Then in Orders Toolbar, click Add button
    Then set Order Details form Ship-From to default
    Then set Order Details form Ship-To to Domestic Address PM Lg FR Box, SDC-1200, 7065 N Ingram Ave, Fresno CA 93650-1083
    Then on Order Details form, select service PM Large Flat Rate Box
    Then set Order Details form Ounces to 1
    Then in Orders Toolbar, click Add button
    Then set Order Details form Ship-From to default
    Then set Order Details form Ship-To to Domestic Address PM RR Box A, SDC-1200, 4937 79th St., Sacramento CA 95820-6213
