Feature: Local Rating test for zone 3
  ...
  Scenario:  All Services
    ...
    Then Details: Expect Total Ship Cost is $1.20
    ...
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $6.15

    Then Details: Set Ship-To to address in Zone 3
    Then Details: Select Service Priority Mail Package
    Then Details: Set Weight to 3 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $7.09

    Then Details: Set Ship-To to address in Zone 3
    Then Details: Select Service Priority Mail Large Package
    Then Details: Set Weight to 12 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $12.15
    ...
    Then Details: Set Weight to 13 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $8.72

    Then Details: Set Ship-To to address in Zone 3
    Then Details: Select Service Parcel Select Ground Package/Flat/Thick Envelope
    Then Details: Set Weight to 23 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $16.07

    Then Details: Set Ship-To to address in Zone 3
    Then Details: Select Service Parcel Select Ground Package/Flat/Thick Envelope
    Then Details: Set Weight to 33 lbs 0 oz
    Then Details: Set Tracking to USPS Tracking
    Then Details: Expect Total Ship Cost is $25.69
