  ...
  module Orders
    module GlobalPost
      module YourGlobalPostLabel
        ...
        #     (cache[:global_post_label_title].nil?||!cache[:global_post_label_title].present?)?cache[:global_post_label_title]=StampsField.new(browser.div(css: '')):cache[:global_post_label_title]
        #   end
        # end
        ...
        #       (cache[:global_post_label_body].nil?||!cache[:global_post_label_body].present?)?cache[:global_post_label_body]=StampsField.new(browser.div(css: '')):cache[:global_post_label_body]
        #     end
        # end
        ...
        class GlobalPostLabelModal < WebApps::Base
          ...
          def close
            StampsField.new(browser.div(css: "")) #change me
          end
