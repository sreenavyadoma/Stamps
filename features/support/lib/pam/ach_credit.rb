module Stamps
  module Pam
    class ACHCreditError < Browser::StampsBase
    ...
    class ACHCreditConfirmation < Browser::StampsBase
      attr_reader :title, :ok_button
    ...
    class ACHPurchaseVerification < Browser::StampsBase
    ...
    class ACHCredit < Browser::StampsBase
