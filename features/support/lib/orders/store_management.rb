  ...
  module Orders
    module Stores
      ...
      class StoreSettings < Browser::Modal
        class ServiceMappingGrid < Browser::Modal
          ...
          class ServiceMappingLineItem < Browser::Modal
            ...
            class ServiceMappingShippingService < Browser::Modal
              ...
              def text_box
                BrowserTextBox.new text_box_field
              end
        ...
        def store_nickname
          BrowserTextBox.new ((browser.text_fields css: "input[name^=textfield-][name$=-inputEl][maxlength='50']").last)
        end
          ...
          def select store_name
            3.times do
              begin
                ...
                checkbox = BrowserCheckbox.new checkbox_field, check_verify_field, "class", "focused"
                checkbox.check
                checkbox.check
                checkbox.check
                checkbox.check
