module Stamps
  module Orders
    module Stores
      class LookingForShipStaion < Browser::Base
      ...
      class AddAdvancedShippingFeatures < Browser::Base
        ...
        def li_1
          (cache[:li_1].nil?||!cache[:li_1].present?)?cache[:li_1]=StampsField.new(browser.span(text: "Includes core app for shipping on the go")):cache[:li_1]
        end
      ...
      class ActivateYourNewFeatures < Browser::Base
