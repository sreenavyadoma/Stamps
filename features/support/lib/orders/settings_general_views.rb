module Stamps
  module Orders
    module Settings
      ...
      class Pounds < Browser::StampsBase
      ...
      class Ounces < Browser::StampsBase
      ...
      class Length < Browser::StampsBase
        attr_reader :textbox, :inc_btn, :dec_btn
      ...
      class Width < Browser::StampsBase
        attr_reader :textbox, :inc_btn, :dec_btn
      ...
      class Height < Browser::StampsBase
        attr_reader :textbox
      ...
      class SettingsLogoffDropDown < Browser::StampsBase
        def textbox
      ...
      class PostDateDropDown < Browser::StampsBase
      ...
      class PostageBalanceDropDown < Browser::StampsBase
        attr_reader :textbox, :dropdown
      ...
      class Dimensions < Browser::StampsBase
      ...
      class ResetFields < Browser::StampsBase
        def present?
      ...
      class GeneralSettings < Browser::StampsBase
      ...
      class GeneralTabView < Browser::StampsBase
      ...
      class InternationalTabView < Browser::StampsBase
        def gen_settings_header
      ...
      class LabelMessagesTabView < Browser::StampsBase
