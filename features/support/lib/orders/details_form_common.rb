    ...
    module DetailsFormCommon
      ...
      class DetailsFormShipFrom < Browser::StampsModal
        ...
        def select(str)
          ...
          dropdown.click
          sleep(0.5)
          selection=StampsField.new((str.downcase.include?('default'))?browser.lis(css: "[class*='x-boundlist-item-over'][data-recordindex='0']")[(form_type==:single_order)?0:1]:browser.lis(text: /#{str}/)[(form_type==:multi_order_details)?0:1])
