    ...
    module DetailsFormCommon #todo-ORDERSAUTO-3737
      ...
      class ShipFromField < Browser::Base
        ...
        def select(str)
          ...
          dropdown.click
          15.times do
            selection1 = (str.downcase.include?('default')) ? browser.lis(css: "[class*='x-boundlist-item-over'][data-recordindex='0']")[0] : browser.lis(visible_text: /#{str}/)[0]
            selection2 = (str.downcase.include?('default')) ? browser.lis(css: "[class*='x-boundlist-item-over'][data-recordindex='0']")[1] : browser.lis(visible_text: /#{str}/)[1]
