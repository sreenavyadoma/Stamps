module Stamps
  module Orders
    module DetailsFormCommon
      ...
      class DetailsFormDimensions < Browser::StampsBase
      ...
      class DetailsFormShipFrom < Browser::StampsBase
      ...
      class DetailsFormService < Browser::StampsBase
      ...
      class OrderDetailsWeight < Browser::StampsBase
        attr_reader :lb, :oz
        def initialize(param, form_type)
          super(param)
          case form_type
