    ...
    module Stores
      ...
      module StoreSettings
        module StoreBaseSettings
          class << self
            ...
            module ClassMethods
              ...
              def assign_window_title(window_title)
        ...
        class PaypalSettings < ::Base
          include StoreIframe
          assign_iframe(store_iframe)
          assign_window_title(browser.div(text: 'PayPal Settings'))
        end
      end
    end
  end
