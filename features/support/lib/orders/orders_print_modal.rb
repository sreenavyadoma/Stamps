...
module Stamps
  module Orders
    module Printing
      ...
      class  OrdersDatePicker < Browser::BaseCache
        assign({})
        def todays_date_div
        ...
        def today_plus(day)
          ...
          ship_date_str=test_helper.this_month_plus(day) #ex: January 17
          ship_date_mmddyy=test_helper.today_plus(day) #ex: 01/17/2018
