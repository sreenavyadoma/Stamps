        ...
        def selection_field(media)
          case(media)
            when /Paper/ # Shipping Label: 8 ½" x 11" Paper
              return StampsField.new(driver.li text: /Paper/)
            when /SDC-1200/ # Shipping Label: Stamps.com SDC-1200, 4 ¼" x 6 ¾"
              return StampsField.new(driver.li text: /SDC-1200/)
            when /Shipping Label - 5 / # Shipping Label: 5 ½" x 8 ½"
              return StampsField.new(driver.li text: /Shipping Label - 5 /)
            when /Roll - 418x614/ # Roll 418x614
              return StampsField.new(driver.li text: /Roll - 4 ⅛/)
