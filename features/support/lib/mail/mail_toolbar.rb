module Stamps
  module Mail
    ...
    class MailToolbar < Browser::StampsBase
      ...
      def incomplete_window_title
        (cache[:incomplete_window_title].nil?||!cache[:incomplete_window_title].present?)?cache[:incomplete_window_title]=Browser::StampsBase.new(param).extend(IncFeldsWindowTitle):cache[:incomplete_window_title]
      end
    ...
    class PrintingProblem < Browser::StampsBase
      def field
