  ...
  module Mail
    ...
    class PrintPostageCustoms < Browser::Modal
      def edit_form
        ...
        "Unable to open Customs Modal, check your test").to eql 'Edit Customs Modal failed.'
      end
    ...
    class MailForm < Browser::Modal
      ...
      def open_extra_services
        ...
        'Extra Services Modal is present.').to eql 'Extra Services modal failed to open.' unless service_modal.present?
      end
    end
  end
end