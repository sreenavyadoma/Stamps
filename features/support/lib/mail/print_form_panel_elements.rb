module Stamps
  module Mail
    module PrintFormPanel
      ...
      class UpgradePlan < Browser::StampsBase
      ...
      class ManagePrintOptionsModal < Browser::StampsBase
      ...
      class PrintOn < Browser::StampsBase
      ...
      class MailToCountry < Browser::StampsBase
        include PrintFormBlurOut
        def dom_dd
      ...
      class MailToInt < Browser::StampsBase
        include PrintFormBlurOut
        def name
      ...
      class MailToDom < Browser::StampsBase
      ...
      class PrintFormEmail < Browser::StampsBase
        include PrintFormBlurOut
        def email_textbox
      ...
      class PrintFormWeight < Browser::StampsBase
        include PrintFormBlurOut
        def weigh
      ...
      class PrintFormDimensions < Browser::StampsBase
        def length
      ...
      class PrintFormMailFrom < Browser::StampsBase
        include PrintFormBlurOut
        def textbox
      ...
      class MailServiceSelection < Browser::StampsBase
      ...
      class PrintFormService < Browser::StampsBase
        include PrintFormBlurOut
      ...
      class PrintFormInsureFor < Browser::StampsBase
        include PrintFormBlurOut
        def price
      ...
      class PrintFormTracking < Browser::StampsBase
        include PrintFormBlurOut
        def textbox
          (cache[:textbox].nil?||!cache[:textbox].present?)?cache[:textbox]=StampsTextbox.new(
      ...
      class PrintFormCostCode < Browser::StampsBase
        def textbox
      ...
      class PrintFormMailToLink < Browser::StampsBase
        def link
      ...
      class PrintFormMailTo < Browser::StampsBase
        include PrintFormBlurOut
        def mail_to_country
      ...
      class PrintFormCustoms < Browser::StampsBase
