    ...
    module PrintFormPanel
      ...
      class MailWeight < Browser::Modal
        ...
        def initialize(param)
          ...
          @mail_pounds = MailPounds.new(param)
          @mail_ounces = MailOunces.new(param)
        end
      ...
      class MailService < Browser::Modal
        ...
        def select(str)
          ...
          10.times {
            begin
              break if text_box.safe_text == (data_for(:mail_services, {})[str]['text_box'])
              drop_down.safe_click unless selection.present?
              selection.scroll_into_view
              selection.safe_click
            rescue
          ...
          expect(text_box.safe_text).to eql(data_for(:mail_services, {})[str]['text_box'])
      ...
      class MailPounds < Browser::Modal
      ...
      class MailOunces < Browser::Modal
