  ...
  module Print
    module Postage
      ...
      class PrintOn < Browser::Modal
        ...
        def drop_down
          ElementWrapper.new ((browser.divs (Print::Locators::FormBody.print_on_drop_down_divs))[0])
        end

        def text_box
          TextBoxElement.new (browser.text_field Print::Locators::FormBody.print_on_text_field)
        end
