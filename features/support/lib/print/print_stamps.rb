    ...
    module Postage
      class NetStamps < Print::Postage::PrintPostageObject
        ...
        def calculate_postage_amount
          checkbox = BrowserCheckbox.new (browser.input id: "sdc-mainpanel-calculatepostageradio-inputEl"), (browser.table id: "sdc-mainpanel-calculatepostageradio"), "class", "checked"
          checkbox.check
          CalculatePostageAmount.new param
        end

        def specify_postage_amount
          checkbox = BrowserCheckbox.new (browser.input id: "sdc-mainpanel-specifypostageradio-inputEl"), (browser.table id: "sdc-mainpanel-specifypostageradio"), "class", "checked"
          checkbox.check
