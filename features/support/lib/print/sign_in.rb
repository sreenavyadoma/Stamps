module Print
  class SignInPage < PrintObject
    ...
    def sign_in_with_credentials *args
      ...
      username_textbox = Textbox.new @browser.text_field Orders::Locators::SignIn.username
      password_textbox = Textbox.new @browser.text_field Orders::Locators::SignIn.password_text_field
      sign_in_button = Button.new @browser.button Orders::Locators::SignIn.button
