module Print
  module Postage
    ...
    class CustomsForm < Print::Postage::PrintObject
      ...
      def save
        button = Button.new (@browser.spans :text => "Save")[0]
        button.safe_click
      end
      ...
      def add_item
        ...
        button = Button.new @browser.span :text => "Add Item"
        5.times do
      ...
      def edit_item
        ...
        button = Button.new @browser.span :text => "Edit Item"
        5.times do
          browser_helper.safe_click button
      ...
      def delete
        button = Button.new @browser.span :text => "Delete"
        browser_helper.safe_click button
      end
    ...
    class AddItemModal < Print::Postage::PrintObject
      ...
      class Lbs  < Print::Postage::PrintObject
        ...
        def increment value
          button = Button.new (@browser.divs :css => "div[class*=x-form-spinner-up]")[10]
          value.to_i.times do
            button.safe_click
          end
        end
        ...
        def decrement value
          button = Button.new (@browser.divs :css => "div[class*=x-form-spinner-down]")[10]
          value.to_i.times do
            button.safe_click
          end
        end
      ...
      class Ounces  < Print::Postage::PrintObject
        ...
        def increment value
          button = Button.new (@browser.divs :css => "div[class*=x-form-spinner-up]")[11]
          value.to_i.times do
            button.safe_click
          end
        end
        ...
        def decrement value
          button = Button.new (@browser.divs :css => "div[class*=x-form-spinner-down]")[11]
          value.to_i.times do
            button.safe_click
          end
        end
      ...
      class Origin  < Print::Postage::PrintObject
        ...
        def drop_down
          button = Button.new (@browser.divs :css => "div[class*=x-form-arrow-trigger]")[12]
        end
