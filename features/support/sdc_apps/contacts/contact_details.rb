module SdcContacts
  module ContactDetails
    ...
    class Panel < SdcPage
      ...
      def contacts_email_error #todo-Aloha this doesn't belong here. move it to SdcContacts.modals.email_error (this is how I want this to look like in step definitions.)
        ContactsEmailErrorMessage.new
      end

      def contacts_column #todo-Aloha This doesn't belong here. This is part of SdcContacts::Grid, change the step def where this is being called.
