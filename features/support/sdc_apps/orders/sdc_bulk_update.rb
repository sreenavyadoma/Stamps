module Stamps
  module Orders
    ...
    class SdcBulkShipFrom < SdcPage
      ...
      checkbox(:ship_from_cb, :ship_from_chooser, :ship_from_verify, 'class', 'checked')
    ...
    class SdcBulkWeight < SdcPage
      ...
      checkbox(:weight_cb, :weight_chooser, :weight_verify, 'class', 'checked')
    ...
    class SdcBulkDomService < SdcPage
      ...
      checkbox(:domservice_cb, :domservice_chooser, :domservice_verify, 'class', 'checked')
    ...
    class SdcBulkIntlService < SdcPage
      ...
      checkbox(:intlservice_cb, :intlservice_chooser, :intlservice_verify, 'class', 'checked')
    ...
    class SdcBulkInsurance < SdcPage
      ...
      checkbox(:insurance_cb, :insurance_chooser, :insurance_verify, 'class', 'checked')
    ...
    class SdcBulkInsureAmt < SdcPage
      ...
      checkbox(:insureamt_cb, :insureamt_chooser, :insureamt_verify, 'class', 'checked')
    ...
    class SdcBulkTracking < SdcPage
      ...
      checkbox(:tracking_cb, :tracking_chooser, :tracking_verify, 'class', 'checked')
    ...
    class SdcBulkDimensions < SdcPage
      ...
      checkbox(:dimension_cb, :dimension_chooser, :dimension_verify, 'class', 'checked')
