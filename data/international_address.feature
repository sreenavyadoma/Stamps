...
Feature:  B-01813 - Allow Int'l and APO/FPO Printing (CN22 and CP72)
  ...
  Scenario:  User Enters International Address, User Changes Ship To Country, Ship To Country is NOT United States, ser Edits Component Int'l Address Fields, Field Attributes
    * Add new order
  ...
  Scenario:  User Edits Customs Form
    * Add new order